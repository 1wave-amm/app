import { m as l, n as w, o as y, p, I as h, q as g, r as k, t as O, u as L, v as m, x as E } from "./embeddable-entry-DYHIgI6c.js";
class x extends l {
...
async function P(n, { blockNumber: e, blockTag: a, data: o, to: c }) {
  ...
  try {
    ...
    const f = await v({ data: u, sender: r, urls: i }), { data: b } = await k(n, {
      blockNumber: e,
      blockTag: a,
      data: O([
        t,
...
async function v({ data: n, sender: e, urls: a }) {
  var c;
