...
var us = (e, t, n) => t in e ? cs(e, t, { enumerable: !0, configurable: !0, writable: !0, value: n }) : e[t] = n;
var F = (e, t, n) => us(e, typeof t != "symbol" ? t + "" : t, n);
import { aj as ge, ak as Ce, al as ds, h as ze, D as be, K as M, ac as qt, j as ot, am as ve, a4 as ke, an as Aa, ao as mn, ap as ls, B as _, aq as fs, ar as Tr, d as ps, as as ms, at as ys, au as hs, Z as ct, a3 as nr, V as rr, S as Te, av as gs, a5 as Pa, aw as bs, ax as ws, ay as vs, s as xs, a7 as Es, a8 as ks, az as Ss, aA as As, aB as Ps, aC as Os, af as _r, z as _t, k as Ge, aD as Ve, aE as ar, aF as Bt, aG as Is, aH as Pe, aI as Cs, aJ as Ts, aK as _s, aL as Oa, aM as Bs, aN as Rs, aO as Us, aP as Ns, ab as Ia, aQ as js, ag as qe, aR as Br, R as yn, a1 as Rr, aS as Ca, F as Ds, aT as Ms, aU as Ur, aV as Ta, $ as mt, i as Ls } from "./embeddable-entry-DYHIgI6c.js";
import { c as Fs, s as tn, p as Gs, w as _a, a as Ks, e as Hs } from "./parseSignature-yQseP01i.js";
...
const qs = /* @__PURE__ */ ge({
  ...
  sourceId: yt
}), Qs = "@base-org/account", $s = "2.4.0", Ra = {
  name: Qs,
  version: $s
}, eo = "https://keys.coinbase.com/connect", hn = "https://rpc.wallet.coinbase.com", Zt = Ra.name, et = Ra.version;
function Ua(e, t) {
  let n;
  try {
    n = e();
  ...
  return {
    getItem: (a) => {
      var i;
      const s = (u) => u === null ? null : JSON.parse(u, void 0), o = (i = n.getItem(a)) != null ? i : null;
...
const gn = (e) => (t) => {
  ...
  const y = () => {
    ...
    s = !1, o.forEach((v) => {
      var P;
      return v((P = r()) != null ? P : p);
    });
    const E = ((b = i.onRehydrateStorage) == null ? void 0 : b.call(i, (m = r()) != null ? m : p)) || void 0;
    return gn(c.getItem.bind(c))(i.name).then((v) => {
      if (v)
        if (typeof v.version == "number" && v.version !== i.version) {
          if (i.migrate) {
            ...
            return P instanceof Promise ? P.then((N) => [!0, N]) : [!0, P];
          }
          console.error(
      ...
      E == null || E(d, void 0), d = r(), s = !0, u.forEach((v) => v(d));
    }).catch((v) => {
      E == null || E(void 0, v);
    });
  };
  ...
  const n = /* @__PURE__ */ new Set(), r = (c, f) => {
    ...
    if (!Object.is(l, t)) {
      const p = t;
      t = f ?? (typeof l != "object" || l === null) ? l : Object.assign({}, t, l), n.forEach((d) => d(t, p));
    }
  }, a = () => t, o = { setState: r, getState: a, getInitialState: () => u, subscribe: (c) => (n.add(c), () => n.delete(c)) }, u = t = e(r, a, o);
  return o;
}, ir = (e) => e ? Nr(e) : Nr, ro = () => ({
  chains: []
}), ao = () => ({
  ...
  get: () => $.getState().subAccount,
  set: (e) => {
    $.setState((t) => ({
      subAccount: t.subAccount ? { ...t.subAccount, ...e } : { address: e.address, ...e }
    }));
  },
  clear: () => {
    $.setState({
  ...
  get: () => $.getState().spendPermissions,
  set: (e) => {
    $.setState({ spendPermissions: e });
  },
  clear: () => {
    $.setState({
      spendPermissions: []
  ...
  get: (e) => $.getState().keys[e],
  set: (e, t) => {
    $.setState((n) => ({ keys: { ...n.keys, [e]: t } }));
  },
  clear: () => {
    $.setState({
      keys: {}
  ...
  get: () => $.getState().config,
  set: (e) => {
    $.setState((t) => ({ config: { ...t.config, ...e } }));
  }
}, ho = {
  subAccounts: fo,
  subAccountsConfig: lo,
  spendPermissions: sr,
  account: po,
  chains: mo,
  keys: yo,
  ...
  try {
    ...
    n.textContent = go, n.type = "text/javascript", document.head.appendChild(n), wo(), document.head.removeChild(n), e();
  } catch {
  ...
  if (typeof window < "u") {
    ...
    if (window.ClientAnalytics) {
      ...
      }), n({ deviceId: e }), x.config.set({ deviceId: e });
    }
  }
}, vo = "0xba5ed110efdba3d005bfc882d75358acbbb85842", he = [
...
}, Da = "Unspecified error message.", xo = "Unspecified server error.";
function or(e, t = Da) {
...
function ko(e, { shouldIncludeStack: t = !1 } = {}) {
  const n = {};
  if (e && typeof e == "object" && !Array.isArray(e) && wn(e, "code") && Eo(e.code)) {
    const r = e;
    n.code = r.code, r.message && typeof r.message == "string" ? (n.message = r.message, wn(r, "data") && (n.data = r.data)) : (n.message = or(n.code), n.data = { originalError: jr(e) });
  } else
    n.code = X.rpc.internal, n.message = Dr(e, "message") ? e.message : Da, n.data = { originalError: jr(e) };
  return t && (n.stack = Dr(e, "stack") ? e.stack : void 0), n;
}
function Ma(e) {
...
const k = {
  ...
  provider: {
    userRejectedRequest: (e) => Fe(X.provider.userRejectedRequest, e),
    unauthorized: (e) => Fe(X.provider.unauthorized, e),
    unsupportedMethod: (e) => Fe(X.provider.unsupportedMethod, e),
    disconnected: (e) => Fe(X.provider.disconnected, e),
    chainDisconnected: (e) => Fe(X.provider.chainDisconnected, e),
    unsupportedChain: (e) => Fe(X.provider.unsupportedChain, e),
    custom: (e) => {
      if (!e || typeof e != "object" || Array.isArray(e))
...
function fe(e, t) {
  const [n, r] = La(t);
  return new cr(e, n || or(e), r);
}
function Fe(e, t) {
  const [n, r] = La(t);
  return new Fa(e, n || or(e), r);
}
function La(e) {
  if (e) {
    if (typeof e == "string")
...
function Ao(e) {
  try {
    ...
    return new cr(t.code, t.message, t.data);
  } catch {
    return null;
  }
}
...
const Po = `Base Account SDK requires the Cross-Origin-Opener-Policy header to not be set to 'same-origin'. This is to ensure that the SDK can communicate with the Base Account app.

Please see https://docs.base.org/smart-wallet/quickstart#cross-origin-opener-policy for more information.`, Oo = () => {
  let e;
  return {
    ...
    checkCrossOriginOpenerPolicy: async () => {
      ...
      try {
        ...
        e = n.headers.get("Cross-Origin-Opener-Policy") ?? "null", e === "same-origin" && console.error(Po);
      } catch (t) {
        console.error("Error checking Cross-Origin-Opener-Policy:", t.message), e = "error";
      }
    }
  };
}, { checkCrossOriginOpenerPolicy: Io, getCrossOriginOpenerPolicy: Co } = Oo();
function To(e) {
  if (e) {
...
function Z(e, t, n) {
  var r, a;
  typeof window < "u" && window.ClientAnalytics && ((a = window.ClientAnalytics) == null || a.logEvent(e, {
    ...t,
    sdkVersion: et,
    sdkName: Zt,
...
}, De = ({ dialogContext: e, dialogAction: t }) => {
...
`, Fr = "BaseSans-Regular";
function No() {
  if (document.head.querySelector(`style[base-sdk-font="${Fr}"]`))
    return;
  const t = document.createElement("style");
  t.setAttribute("base-sdk-font", Fr), t.textContent = Uo, document.head.appendChild(t);
}
var Wt, G, Ha, Be, Gr, za, vn, dr, xn, En, ut = {}, Va = [], jo = /acit|ex(?:s|g|n|p|$)|rph|grid|ows|mnc|ntw|ine[ch]|zoo|^ord|itera/i, lr = Array.isArray;
function Oe(e, t) {
...
function Za(e, t, n) {
  ...
  return It(e, s, r, a, null);
}
function It(e, t, n, r, a) {
  var i = { type: e, props: t, key: n, ref: r, __k: null, __: null, __b: 0, __e: null, __d: void 0, __c: null, constructor: void 0, __v: a ?? ++Ha, __i: -1, __u: 0 };
  return a == null && G.vnode != null && G.vnode(i), i;
}
function Jt(e) {
  return e.children;
}
...
function Kr(e) {
  (!e.__d && (e.__d = !0) && Be.push(e) && !Rt.__r++ || Gr !== G.debounceRendering) && ((Gr = G.debounceRendering) || za)(Rt);
}
function Rt() {
  var e, t, n, r, a, i, s, o;
  for (Be.sort(vn); e = Be.shift(); ) e.__d && (t = Be.length, r = void 0, i = (a = (n = e).__v).__e, s = [], o = [], n.__P && ((r = Oe({}, a)).__v = a.__v + 1, G.vnode && G.vnode(r), fr(n.__P, r, a, n.__n, n.__P.namespaceURI, 32 & a.__u ? [i] : null, s, i ?? We(a), !!(32 & a.__u), o), r.__v = a.__v, r.__.__k[r.__i] = r, Xa(s, r, o), r.__e != i && Wa(r)), Be.length > t && Be.sort(vn));
  Rt.__r = 0;
}
function Ja(e, t, n, r, a, i, s, o, u, c, f) {
  var l, p, d, y, m, b = r && r.__k || Va, E = t.length;
  for (n.__d = u, Do(n, t, b), u = n.__d, l = 0; l < E; l++) (d = n.__k[l]) != null && (p = d.__i === -1 ? ut : b[d.__i] || ut, d.__i = l, fr(e, d, p, a, i, s, o, u, c, f), y = d.__e, d.ref && p.ref != d.ref && (p.ref && pr(p.ref, null, d), f.push(d.ref, d.__c || y, d)), m == null && y != null && (m = y), 65536 & d.__u || p.__k === d.__k ? u = Ya(d, u, e) : typeof d.type == "function" && d.__d !== void 0 ? u = d.__d : y && (u = y.nextSibling), d.__d = void 0, d.__u &= -196609);
  n.__d = u, n.__e = m;
}
function Do(e, t, n) {
  var r, a, i, s, o, u = t.length, c = n.length, f = c, l = 0;
  for (e.__k = [], r = 0; r < u; r++) (a = t[r]) != null && typeof a != "boolean" && typeof a != "function" ? (s = r + l, (a = e.__k[r] = typeof a == "string" || typeof a == "number" || typeof a == "bigint" || a.constructor == String ? It(null, a, null, null, null) : lr(a) ? It(Jt, { children: a }, null, null, null) : a.constructor === void 0 && a.__b > 0 ? It(a.type, a.props, a.key, a.ref ? a.ref : null, a.__v) : a).__ = e, a.__b = e.__b + 1, i = null, (o = a.__i = Mo(a, n, s, f)) !== -1 && (f--, (i = n[o]) && (i.__u |= 131072)), i == null || i.__v === null ? (o == -1 && l--, typeof a.type != "function" && (a.__u |= 65536)) : o !== s && (o == s - 1 ? l-- : o == s + 1 ? l++ : (o > s ? l-- : l++, a.__u |= 65536))) : a = e.__k[r] = null;
  if (f) for (r = 0; r < c; r++) (i = n[r]) != null && !(131072 & i.__u) && (i.__e == e.__d && (e.__d = We(i)), Qa(i, i));
}
function Ya(e, t, n) {
  var r, a;
  if (typeof e.type == "function") {
    for (r = e.__k, a = 0; r && a < r.length; a++) r[a] && (r[a].__ = e, t = Ya(r[a], t, n));
    return t;
  }
...
function Mo(e, t, n, r) {
  var a = e.key, i = e.type, s = n - 1, o = n + 1, u = t[n];
  if (u === null || u && a == u.key && i === u.type && !(131072 & u.__u)) return n;
  if (r > (u != null && !(131072 & u.__u) ? 1 : 0)) for (; s >= 0 || o < t.length; ) {
    if (s >= 0) {
      if ((u = t[s]) && !(131072 & u.__u) && a == u.key && i === u.type) return s;
      s--;
    }
    if (o < t.length) {
      if ((u = t[o]) && !(131072 & u.__u) && a == u.key && i === u.type) return o;
      o++;
    }
  }
  return -1;
...
function Hr(e, t, n) {
  t[0] === "-" ? e.setProperty(t, n ?? "") : e[t] = n == null ? "" : typeof n != "number" || jo.test(t) ? n : n + "px";
}
function ht(e, t, n, r, a) {
  var i;
  e: if (t === "style") if (typeof n == "string") e.style.cssText = n;
  else {
    if (typeof r == "string" && (e.style.cssText = r = ""), r) for (t in r) n && t in n || Hr(e.style, t, "");
    if (n) for (t in n) r && n[t] === r[t] || Hr(e.style, t, n[t]);
  }
  else if (t[0] === "o" && t[1] === "n") i = t !== (t = t.replace(/(PointerCapture)$|Capture$/i, "$1")), t = t.toLowerCase() in e || t === "onFocusOut" || t === "onFocusIn" ? t.toLowerCase().slice(2) : t.slice(2), e.l || (e.l = {}), e.l[t + i] = n, n ? r ? n.u = r.u : (n.u = dr, e.addEventListener(t, i ? En : xn, i)) : e.removeEventListener(t, i ? En : xn, i);
  else {
...
function fr(e, t, n, r, a, i, s, o, u, c) {
  var f, l, p, d, y, m, b, E, v, P, N, ee, ae, R, j, B, se = t.type;
  if (t.constructor !== void 0) return null;
  128 & n.__u && (u = !!(32 & n.__u), i = [o = t.__e = n.__e]), (f = G.__b) && f(t);
  e: if (typeof se == "function") try {
    if (E = t.props, v = "prototype" in se && se.prototype.render, P = (f = se.contextType) && r[f.__c], N = f ? P ? P.props.value : f.__ : r, n.__c ? b = (l = t.__c = n.__c).__ = l.__E : (v ? t.__c = l = new se(E, N) : (t.__c = l = new Ct(E, N), l.constructor = se, l.render = Fo), P && P.sub(l), l.props = E, l.state || (l.state = {}), l.context = N, l.__n = r, p = l.__d = !0, l.__h = [], l._sb = []), v && l.__s == null && (l.__s = l.state), v && se.getDerivedStateFromProps != null && (l.__s == l.state && (l.__s = Oe({}, l.__s)), Oe(l.__s, se.getDerivedStateFromProps(E, l.__s))), d = l.props, y = l.state, l.__v = t, p) v && se.getDerivedStateFromProps == null && l.componentWillMount != null && l.componentWillMount(), v && l.componentDidMount != null && l.__h.push(l.componentDidMount);
    else {
      if (v && se.getDerivedStateFromProps == null && E !== d && l.componentWillReceiveProps != null && l.componentWillReceiveProps(E, N), !l.__e && (l.shouldComponentUpdate != null && l.shouldComponentUpdate(E, l.__s, N) === !1 || t.__v === n.__v)) {
      ...
      l.componentWillUpdate != null && l.componentWillUpdate(E, l.__s, N), v && l.componentDidUpdate != null && l.__h.push(function() {
        l.componentDidUpdate(d, y, m);
      });
    }
    if (l.context = N, l.props = E, l.__P = e, l.__e = !1, ae = G.__r, R = 0, v) {
      for (l.state = l.__s, l.__d = !1, ae && ae(t), f = l.render(l.props, l.state, l.context), j = 0; j < l._sb.length; j++) l.__h.push(l._sb[j]);
      l._sb = [];
    } else do
      l.__d = !1, ae && ae(t), f = l.render(l.props, l.state, l.context), l.state = l.__s;
    while (l.__d && ++R < 25);
    l.state = l.__s, l.getChildContext != null && (r = Oe(Oe({}, r), l.getChildContext())), v && !p && l.getSnapshotBeforeUpdate != null && (m = l.getSnapshotBeforeUpdate(d, y)), Ja(e, lr(B = f != null && f.type === Jt && f.key == null ? f.props.children : f) ? B : [B], t, n, r, a, i, s, o, u, c), l.base = t.__e, t.__u &= -161, l.__h.length && s.push(l), b && (l.__E = l.__ = null);
  } catch (le) {
  ...
  else i == null && t.__v === n.__v ? (t.__k = n.__k, t.__e = n.__e) : t.__e = Lo(n.__e, t, n, r, a, i, s, u, c);
  (f = G.diffed) && f(t);
}
function Xa(e, t, n) {
  t.__d = void 0;
  for (var r = 0; r < n.length; r++) pr(n[r], n[++r], n[++r]);
  G.__c && G.__c(t, e), e.some(function(a) {
    try {
...
function Lo(e, t, n, r, a, i, s, o, u) {
  var c, f, l, p, d, y, m, b = n.props, E = t.props, v = t.type;
  if (v === "svg" ? a = "http://www.w3.org/2000/svg" : v === "math" ? a = "http://www.w3.org/1998/Math/MathML" : a || (a = "http://www.w3.org/1999/xhtml"), i != null) {
    for (c = 0; c < i.length; c++) if ((d = i[c]) && "setAttribute" in d == !!v && (v ? d.localName === v : d.nodeType === 3)) {
      e = d, i[c] = null;
      break;
    }
  }
  if (e == null) {
    if (v === null) return document.createTextNode(E);
    e = document.createElementNS(a, v, E.is && E), o && (G.__m && G.__m(t, i), o = !1), i = null;
  }
  if (v === null) b === E || o && e.data === E || (e.data = E);
  else {
    if (i = i && Wt.call(e.childNodes), b = n.props || ut, !o && i != null) for (b = {}, c = 0; c < e.attributes.length; c++) b[(d = e.attributes[c]).name] = d.value;
    for (c in b) if (d = b[c], c != "children") {
    ...
    for (c in E) d = E[c], c == "children" ? p = d : c == "dangerouslySetInnerHTML" ? f = d : c == "value" ? y = d : c == "checked" ? m = d : o && typeof d != "function" || b[c] === d || ht(e, c, d, b[c], a);
    if (f) o || l && (f.__html === l.__html || f.__html === e.innerHTML) || (e.innerHTML = f.__html), t.__k = [];
    else if (l && (e.innerHTML = ""), Ja(e, lr(p) ? p : [p], t, n, r, v === "foreignObject" ? "http://www.w3.org/1999/xhtml" : a, i, s, i ? i[0] : n.__k && We(n, 0), o, u), i != null) for (c = i.length; c--; ) qa(i[c]);
    o || (c = "value", v === "progress" && y == null ? e.removeAttribute("value") : y !== void 0 && (y !== e[c] || v === "progress" && !y || v === "option" && y !== b[c]) && ht(e, c, y, b[c], a), c = "checked", m !== void 0 && m !== e[c] && ht(e, c, m, b[c], a));
  }
  return e;
}
function pr(e, t, n) {
...
function Qa(e, t, n) {
  var r, a;
  if (G.unmount && G.unmount(e), (r = e.ref) && (r.current && r.current !== e.__e || pr(r, null, t)), (r = e.__c) != null) {
  ...
  if (r = e.__k) for (a = 0; a < r.length; a++) r[a] && Qa(r[a], t, n || typeof e.type != "function");
  n || qa(e.__e), e.__c = e.__ = e.__e = e.__d = void 0;
}
function Fo(e, t, n) {
...
function Vr(e, t, n) {
  var r, a, i, s;
  G.__ && G.__(e, t), a = (r = !1) ? null : t.__k, i = [], s = [], fr(t, e = t.__k = Za(Jt, null, [e]), a || ut, ut, t.namespaceURI, a ? null : t.firstChild ? Wt.call(t.childNodes) : null, i, a ? a.__e : t.firstChild, r, s), Xa(i, e, s);
}
Wt = Va.slice, G = { __e: function(e, t, n, r) {
  ...
  throw e;
} }, Ha = 0, Ct.prototype.setState = function(e, t) {
  var n;
  n = this.__s != null && this.__s !== this.state ? this.__s : this.__s = Oe({}, this.state), typeof e == "function" && (e = e(Oe({}, n), this.props)), e && Oe(n, e), e != null && this.__v && (t && this._sb.push(t), Kr(this));
}, Ct.prototype.forceUpdate = function(e) {
  this.__v && (this.__e = !0, e && this.__h.push(e), Kr(this));
}, Ct.prototype.render = Jt, Be = [], za = typeof Promise == "function" ? Promise.prototype.then.bind(Promise.resolve()) : setTimeout, vn = function(e, t) {
  return e.__v.__b - t.__v.__b;
}, Rt.__r = 0, dr = 0, xn = zr(!1), En = zr(!0);
var Go = 0;
function Y(e, t, n, r, a, i) {
  t || (t = {});
  var s, o, u = t;
  "ref" in t && (s = t.ref, delete t.ref);
  var c = { type: e, props: u, key: n, ref: s, __k: null, __: null, __b: 0, __e: null, __d: void 0, __c: null, constructor: void 0, __v: --Go, __i: -1, __u: 0, __source: a, __self: i };
...
function $a(e) {
  ...
  else if (typeof e == "object") if (Array.isArray(e)) for (t = 0; t < e.length; t++) e[t] && (n = $a(e[t])) && (r && (r += " "), r += n);
...
function Zo(e, t, n) {
  var r = mr(dt++, 2);
  if (r.t = e, !r.__c && (r.__ = [ni(void 0, t), function(o) {
    ...
    var a = function(o, u, c) {
      ...
      return f.forEach(function(p) {
        if (p.__N) {
          var d = p.__[0];
          p.__ = p.__N, p.__N = void 0, d !== p.__[0] && (l = !0);
        }
      }), !(!l && r.__c.props === o) && (!i || i.call(this, o, u, c));
    };
    Q.u = !0;
    var i = Q.shouldComponentUpdate, s = Q.componentWillUpdate;
    Q.componentWillUpdate = function(o, u, c) {
      if (this.__e) {
        var f = i;
        i = void 0, a(o, u, c), i = f;
      }
      s && s.call(this, o, u, c);
...
function An(e, t) {
  var n = mr(dt++, 3);
  !te.__s && ti(n.__H, t) && (n.__ = e, n.i = t, Q.__H.__h.push(n));
}
function Wo(e, t) {
  var n = mr(dt++, 7);
...
function Jo() {
  for (var e; e = ei.shift(); ) if (e.__P && e.__H) try {
    e.__H.__h.forEach(Tt), e.__H.__h.forEach(Pn), e.__H.__h = [];
  } catch (t) {
...
te.__b = function(e) {
  ...
  e && t.__k && t.__k.__m && (e.__m = t.__k.__m), Qr && Qr(e, t);
}, te.__r = function(e) {
  Wr && Wr(e), dt = 0;
  var t = (Q = e.__c).__H;
  t && (nn === Q ? (t.__h = [], Q.__h = [], t.__.forEach(function(n) {
    n.__N && (n.__ = n.__N), n.i = n.__N = void 0;
  })) : (t.__h.forEach(Tt), t.__h.forEach(Pn), t.__h = [], dt = 0)), nn = Q;
}, te.diffed = function(e) {
  Jr && Jr(e);
  var t = e.__c;
  t && t.__H && (t.__H.__h.length && (ei.push(t) !== 1 && qr === te.requestAnimationFrame || ((qr = te.requestAnimationFrame) || Yo)(Jo)), t.__H.__.forEach(function(n) {
...
const $o = () => {
  ...
  }, []), e ? Y("div", { class: "-base-acc-sdk-dialog-handle-bar" }) : null;
};
class ec {
  constructor() {
    F(this, "items", /* @__PURE__ */ new Map());
    F(this, "nextItemKey", 0);
    F(this, "root", null);
  }
  attach(t) {
  ...
  clear() {
    this.items.clear(), this.root && Vr(null, this.root);
  }
  render() {
    this.root && Vr(Y("div", { children: Y(tc, { children: Array.from(this.items.entries()).map(([t, n]) => Za(nc, { ...n, key: t, handleClose: () => {
      var r;
...
const tc = (e) => {
  const [t, n] = Me(0), [r, a] = Me(!1), [i, s] = Me(0), o = (f) => {
    if (!ri())
      return;
    const l = f.touches[0];
    s(l.clientY), a(!0);
    ...
    if (!r)
      return;
    const p = f.touches[0].clientY - i;
    p > 0 && (n(p), f.preventDefault());
  }, c = () => {
    if (r)
      if (a(!1), t > 100) {
        const f = document.querySelector(".-base-acc-sdk-dialog-instance-header-close");
        f && f.click();
      } else
        n(0);
  };
  return Y("div", { class: kn("-base-acc-sdk-dialog-container"), children: [Y("style", { children: Xo }), Y("div", { class: "-base-acc-sdk-dialog-backdrop", onTouchStart: o, onTouchMove: u, onTouchEnd: c, children: Y("div", { class: "-base-acc-sdk-dialog", style: {
    transform: `translateY(${t}px)`,
    transition: r ? "none" : "transform 0.2s ease-out"
  }, children: [Y($o, {}), e.children] }) })] });
}, nc = ({ title: e, message: t, actionItems: n, handleClose: r }) => {
  const [a, i] = Me(!0), [s, o] = Me(!0), [u, c] = Me(null);
  An(() => {
    ...
    (async () => {
      var y;
      const d = (y = x.account.get().accounts) == null ? void 0 : y[0];
      if (d) {
        const m = await Ko(d);
        c(m);
      }
  ...
  const f = Wo(() => u ? `Signed in as ${u}` : "Base Account", [u]), l = !s;
  return Y("div", { class: kn("-base-acc-sdk-dialog-instance", a && "-base-acc-sdk-dialog-instance-hidden"), children: [Y("div", { class: "-base-acc-sdk-dialog-instance-header", children: [Y("div", { class: "-base-acc-sdk-dialog-instance-header-icon-and-title", children: [Y(qo, { fill: "blue" }), l && Y("div", { class: "-base-acc-sdk-dialog-instance-header-icon-and-title-title", children: f })] }), Y("div", { class: "-base-acc-sdk-dialog-instance-header-close", onClick: r, children: Y("img", { src: Qo, class: "-base-acc-sdk-dialog-instance-header-close-icon" }) })] }), Y("div", { class: "-base-acc-sdk-dialog-instance-content", children: [Y("div", { class: "-base-acc-sdk-dialog-instance-content-title", children: e }), Y("div", { class: "-base-acc-sdk-dialog-instance-content-message", children: t })] }), n && n.length > 0 && Y("div", { class: "-base-acc-sdk-dialog-instance-actions", children: n.map((p, d) => Y("button", { class: kn("-base-acc-sdk-dialog-instance-button", p.variant === "primary" && "-base-acc-sdk-dialog-instance-button-primary", p.variant === "secondary" && "-base-acc-sdk-dialog-instance-button-secondary"), onClick: p.onClick, children: p.text }, d)) })] });
};
let gt = null;
function yr() {
  if (!gt) {
    const e = document.createElement("div");
    e.className = "-base-acc-sdk-css-reset", document.body.appendChild(e), gt = new ec(), gt.attach(e);
  }
  return No(), gt;
}
const ea = 420, ta = 700, rc = "{app} wants to continue in Base Account", ac = "This action requires your permission to open a new window.";
function ic(e) {
  const t = (window.innerWidth - ea) / 2 + window.screenX, n = (window.innerHeight - ta) / 2 + window.screenY;
  oc(e);
  function r() {
    const i = `wallet_${crypto.randomUUID()}`, s = window.open(e, i, `width=${ea}, height=${ta}, left=${t}, top=${n}`);
    return s == null || s.focus(), s || null;
  }
  const a = r();
  return a ? Promise.resolve(a) : cc(r);
}
function sc(e) {
  e && !e.closed && e.close();
}
...
function cc(e) {
  var r;
  const t = ((r = x.config.get().metadata) == null ? void 0 : r.appName) ?? "App", n = yr();
  return new Promise((a, i) => {
    ur({ dialogContext: "popup_blocked" }), n.presentItem({
      title: rc.replace("{app}", t),
      message: ac,
      onClose: () => {
        De({
...
class uc {
  constructor({ url: t = eo, metadata: n, preference: r }) {
    F(this, "metadata");
    F(this, "preference");
    F(this, "url");
    F(this, "popup", null);
     ...
     */
    F(this, "onMessage", async (t) => new Promise((n, r) => {
      const a = (i) => {
        if (i.origin !== this.url.origin)
          return;
        const s = i.data;
     ...
     */
    F(this, "disconnect", () => {
      sc(this.popup), this.popup = null, this.listeners.forEach(({ reject: t }, n) => {
     ...
     */
    F(this, "waitForPopupLoaded", async () => this.popup && !this.popup.closed ? (this.popup.focus(), this.popup) : (_o(), this.popup = await ic(this.url), this.onMessage(({ event: t }) => t === "PopupUnload").then(() => {
      this.disconnect(), Ro();
    }).catch(() => {
...
function dc(e) {
  ...
  return n.searchParams.set("version", et), n.searchParams.set("code", t.code.toString()), n.searchParams.set("message", t.message), {
    ...t,
    docUrl: n.href
  };
}
...
function fc(e) {
  ...
  if (lc(e)) {
    const t = e.errorMessage, n = e.errorCode ?? (t.match(/(denied|rejected)/i) ? X.provider.userRejectedRequest : void 0);
    return {
      ...e,
      message: t,
      code: n,
...
const mc = ({ method: e, correlationId: t }) => {
...
}, yc = ({ method: e, correlationId: t, errorMessage: n }) => {
...
}, Ke = (e) => "message" in e && typeof e.message == "string" ? e.message : "";
function gc() {
  return (e) => e;
}
const Ut = gc();
...
function ii(e) {
  return Ut(`0x${BigInt(e).toString(16)}`);
}
function xc(e) {
  return e.startsWith("0x") || e.startsWith("0X");
}
function si(e) {
  return xc(e) ? e.slice(2) : e;
}
function Ec(e) {
  if (typeof e != "string")
    return !1;
...
function kc(e, t = !1) {
  let n = On(e, !1);
  return n.length % 2 === 1 && (n = Ut(`0${n}`)), t ? Ut(`0x${n}`) : n;
}
function Sc(e) {
  ...
  if (typeof e == "string") {
    if (bc.test(e))
      return rn(Number(e));
    if (Ec(e))
      return rn(Number(BigInt(kc(e, !0))));
  }
  throw k.rpc.invalidParams(`Not an integer: ${String(e)}`);
}
const Ac = ({ method: e, correlationId: t }) => {
...
}, Pc = ({ method: e, correlationId: t, errorMessage: n }) => {
...
}, Cc = ({ method: e, correlationId: t, errorMessage: n }) => {
  const r = x.subAccountsConfig.get();
...
}, Rc = ({ method: e, correlationId: t, errorMessage: n }) => {
  const r = x.subAccountsConfig.get();
...
}, jc = ({ method: e, correlationId: t, errorMessage: n }) => {
  const r = x.subAccountsConfig.get();
...
}, Lc = ({ method: e, correlationId: t, errorMessage: n }) => {
  const r = x.subAccountsConfig.get();
...
function oi(e) {
  ...
  return n ? ze([n, r ?? "0x"]) : "0x";
}
function ci(e) {
  const { callGasLimit: t, callData: n, maxPriorityFeePerGas: r, maxFeePerGas: a, paymaster: i, paymasterData: s, paymasterPostOpGasLimit: o, paymasterVerificationGasLimit: u, sender: c, signature: f = "0x", verificationGasLimit: l } = e, p = ze([
    be(M(l || 0n), { size: 16 }),
    be(M(t || 0n), { size: 16 })
  ]), d = oi(e), y = ze([
    be(M(r || 0n), { size: 16 }),
...
function Kc(e) {
  const { chainId: t, entryPointAddress: n, userOperation: r } = e, a = ci(r);
  return {
    types: Gc,
...
function Hc(e) {
  const { chainId: t, entryPointAddress: n, entryPointVersion: r } = e, a = e.userOperation, { authorization: i, callData: s = "0x", callGasLimit: o, maxFeePerGas: u, maxPriorityFeePerGas: c, nonce: f, paymasterAndData: l = "0x", preVerificationGas: p, sender: d, verificationGasLimit: y } = a;
  if (r === "0.8")
    return qt(Kc({
      chainId: t,
      entryPointAddress: n,
  ...
  const m = (() => {
    var b, E;
    if (r === "0.6") {
      const v = (b = a.initCode) == null ? void 0 : b.slice(0, 42), P = (E = a.initCode) == null ? void 0 : E.slice(42), N = oi({
        authorization: i,
        factory: v,
        factoryData: P
      });
    ...
    if (r === "0.7") {
      ...
      return ot([
        ...
        v.gasFees,
        ve(v.paymasterAndData)
      ]);
    }
    throw new Error(`entryPointVersion "${r}" not supported.`);
  })();
  return ve(ot([{ type: "bytes32" }, { type: "address" }, { type: "uint256" }], [ve(m), n, BigInt(t)]));
}
async function zc(e) {
  const { extend: t, nonceKeyManager: n = Fs({
    source: {
      get() {
        return Date.now();
      },
  ...
  return {
    ...
    async getNonce(s) {
      const o = (s == null ? void 0 : s.key) ?? BigInt(await n.consume({
        address: i,
        chainId: e.client.chain.id,
        client: e.client
      }));
      return e.getNonce ? await e.getNonce({ ...s, key: o }) : await mn(e.client, {
        abi: ls([
    ...
    async isDeployed() {
      return a ? !0 : (a = !!await ke(e.client, Aa, "getCode")({
        address: i
      }), a);
    },
    ...e.sign ? {
      async sign(s) {
        const [{ factory: o, factoryData: u }, c] = await Promise.all([
          this.getFactoryArgs(),
          e.sign(s)
        ]);
        return o && u ? tn({
...
Object.defineProperty(In, "message", {
  enumerable: !0,
  configurable: !0,
  writable: !0,
  value: /aa20/
...
class Je extends _ {
  constructor({ cause: t, data: n, message: r } = {}) {
    var i;
    const a = (i = r == null ? void 0 : r.replace("execution reverted: ", "")) == null ? void 0 : i.replace("execution reverted", "");
...
Object.defineProperty(Je, "message", {
  enumerable: !0,
  configurable: !0,
  writable: !0,
...
Object.defineProperty(Cn, "message", {
  enumerable: !0,
  configurable: !0,
  writable: !0,
  value: /aa91/
...
Object.defineProperty(_n, "message", {
  enumerable: !0,
  configurable: !0,
  writable: !0,
  value: /aa95/
...
Object.defineProperty(Bn, "message", {
  enumerable: !0,
  configurable: !0,
  writable: !0,
  value: /aa13/
...
Object.defineProperty(Rn, "message", {
  enumerable: !0,
  configurable: !0,
  writable: !0,
  value: /aa15/
...
Object.defineProperty(Un, "message", {
  enumerable: !0,
  configurable: !0,
  writable: !0,
  value: /aa14/
...
Object.defineProperty(Nn, "message", {
  enumerable: !0,
  configurable: !0,
  writable: !0,
  value: /aa21/
...
Object.defineProperty(Dn, "message", {
  enumerable: !0,
  configurable: !0,
  writable: !0,
  value: /aa96/
...
Object.defineProperty(Mn, "message", {
  enumerable: !0,
  configurable: !0,
  writable: !0,
  value: /aa25/
...
Object.defineProperty(Ln, "message", {
  enumerable: !0,
  configurable: !0,
  writable: !0,
  value: /aa90/
...
Object.defineProperty(Re, "message", {
  enumerable: !0,
  configurable: !0,
  writable: !0,
  value: /aa31/
...
Object.defineProperty(Gn, "message", {
  enumerable: !0,
  configurable: !0,
  writable: !0,
  value: /aa33/
...
Object.defineProperty(Hn, "message", {
  enumerable: !0,
  configurable: !0,
  writable: !0,
  value: /aa50/
...
class qc extends _ {
  constructor(t, { callData: n, callGasLimit: r, docsPath: a, factory: i, factoryData: s, initCode: o, maxFeePerGas: u, maxPriorityFeePerGas: c, nonce: f, paymaster: l, paymasterAndData: p, paymasterData: d, paymasterPostOpGasLimit: y, paymasterVerificationGasLimit: m, preVerificationGas: b, sender: E, signature: v, verificationGasLimit: P }) {
    const N = fs({
      ...
      factoryData: s,
      initCode: o,
      maxFeePerGas: typeof u < "u" && `${Tr(u)} gwei`,
      maxPriorityFeePerGas: typeof c < "u" && `${Tr(c)} gwei`,
      nonce: f,
      paymaster: l,
      paymasterAndData: p,
      paymasterData: d,
...
function Yc(e, t) {
  ...
  if (In.message.test(n))
    return new In({
      cause: e
    });
  if (Cn.message.test(n))
    return new Cn({
      cause: e
    });
  ...
  if (_n.message.test(n))
    return new _n({
      cause: e
    });
  if (Bn.message.test(n))
    return new Bn({
      cause: e,
      factory: t.factory,
  ...
  if (Mn.message.test(n))
    return new Mn({
      cause: e,
      nonce: t.nonce
    });
  if (Dn.message.test(n))
    return new Dn({
      cause: e
    });
  if (Ln.message.test(n))
    return new Ln({
      cause: e
    });
  if (Fn.message.test(n))
    return new Fn({
      cause: e
    });
  if (Re.message.test(n))
    return new Re({
      cause: e
    });
  if (Gn.message.test(n))
    return new Gn({
      cause: e
    });
  ...
  const r = e.walk((a) => Jc.some((i) => i.code === a.code));
  if (r) {
    if (r.code === Je.code)
      return new Je({
        cause: e,
...
function ui(e, { calls: t, docsPath: n, ...r }) {
  const a = (() => {
    const i = Yc(e, r);
    if (t && i instanceof Je) {
      const s = Xc(i), o = t == null ? void 0 : t.filter((u) => u.abi);
      if (s && o.length > 0)
        return Qc({ calls: o, revertData: s });
    }
    return i;
  })();
  return new qc(a, {
...
function Xc(e) {
  ...
  return e.walk((n) => {
    var a, i, s, o;
    const r = n;
    if (typeof r.data == "string" || typeof ((a = r.data) == null ? void 0 : a.revertData) == "string" || !(r instanceof _) && typeof r.message == "string") {
      const u = (o = (s = ((i = r.data) == null ? void 0 : i.revertData) || r.data || r.message).match) == null ? void 0 : o.call(s, /(0x[A-Za-z0-9]*)/);
      if (u)
        return t = u[1], !0;
    }
    return !1;
...
function Qc(e) {
  const { calls: t, revertData: n } = e, { abi: r, functionName: a, args: i, to: s } = (() => {
    const u = t == null ? void 0 : t.filter((f) => !!f.abi);
    if (u.length === 1)
      return u[0];
    const c = u.filter((f) => {
      try {
    ...
    return c.length === 1 ? c[0] : {
      abi: [],
      functionName: u.reduce((f, l) => `${f ? `${f} | ` : ""}${l.functionName}`, ""),
      args: void 0,
      to: void 0
    };
  })(), o = n === "0x" ? new ms({ functionName: a }) : new ys({
    abi: r,
    data: n,
    functionName: a
  });
...
function eu(e) {
  return {
    ...
    chainId: M(e.chainId),
    nonce: M(e.nonce),
    r: e.r ? M(BigInt(e.r), { size: 32 }) : be("0x", { size: 32 }),
    s: e.s ? M(BigInt(e.s), { size: 32 }) : be("0x", { size: 32 }),
    yParity: e.yParity ? M(e.yParity, { size: 1 }) : be("0x", { size: 32 })
  };
}
async function tu(e, t) {
  const { chainId: n, entryPointAddress: r, context: a, ...i } = t, s = Yt(i), { paymasterPostOpGasLimit: o, paymasterVerificationGasLimit: u, ...c } = await e.request({
  ...
  return {
    ...c,
    ...o && {
      paymasterPostOpGasLimit: ct(o)
    },
    ...u && {
      paymasterVerificationGasLimit: ct(u)
    }
  };
}
...
async function hr(e, t) {
  var ae;
  const n = t, { account: r = e.account, parameters: a = ru, stateOverride: i } = n;
  if (!r)
    throw new nr();
  const s = rr(r), o = e, u = n.paymaster ?? (o == null ? void 0 : o.paymaster), c = typeof u == "string" ? u : void 0, { getPaymasterStubData: f, getPaymasterData: l } = (() => {
    if (u === !0)
      return {
        getPaymasterStubData: (R) => ke(o, nu, "getPaymasterStubData")(R),
        getPaymasterData: (R) => ke(o, tu, "getPaymasterData")(R)
      };
    if (typeof u == "object") {
      const { getPaymasterStubData: R, getPaymasterData: j } = u;
      return {
        getPaymasterStubData: j && R ? R : j,
        getPaymasterData: j && R ? j : void 0
      };
    }
    return {
  ...
  const [y, m, b, E, v] = await Promise.all([
    (async () => n.calls ? s.encodeCalls(n.calls.map((R) => {
      const j = R;
      return j.abi ? {
        data: Te(j),
        to: j.to,
    ...
    (async () => {
      ...
      const { factory: R, factoryData: j } = await s.getFactoryArgs();
      return s.entryPoint.version === "0.6" ? {
        initCode: R && j ? ze([R, j]) : void 0
      } : {
        factory: R,
        factoryData: j
      };
    ...
    (async () => {
      ...
      if (a.includes("fees")) {
        if (typeof n.maxFeePerGas == "bigint" && typeof n.maxPriorityFeePerGas == "bigint")
          return d;
        if ((R = o == null ? void 0 : o.userOperation) != null && R.estimateFeesPerGas) {
          const j = await o.userOperation.estimateFeesPerGas({
            account: s,
            bundlerClient: o,
            userOperation: d
          });
        ...
        try {
          const j = o.client ?? e, B = await ke(j, gs, "estimateFeesPerGas")({
            chain: j.chain,
            type: "eip1559"
          });
          return {
    ...
    (async () => {
      if (a.includes("authorization")) {
        ...
        if (s.authorization && !await s.isDeployed())
          return {
            ...await Gs(s.client, s.authorization),
  ...
  typeof y < "u" && (d.callData = y), typeof m < "u" && (d = { ...d, ...m }), typeof b < "u" && (d = { ...d, ...b }), typeof E < "u" && (d.nonce = E), typeof v < "u" && (d.authorization = v), a.includes("signature") && (typeof n.signature < "u" ? d.signature = n.signature : d.signature = await s.getStubSignature(d)), s.entryPoint.version === "0.6" && !d.initCode && (d.initCode = "0x");
  let P;
  async function N() {
    return P || (e.chain ? e.chain.id : (P = await ke(e, Pa, "getChainId")({}), P));
  }
  let ee = !1;
  if (a.includes("paymaster") && f && !c && !n.paymasterAndData) {
    const { isFinal: R = !1, sponsor: j, ...B } = await f({
      chainId: await N(),
  ...
  if (s.entryPoint.version === "0.6" && !d.paymasterAndData && (d.paymasterAndData = "0x"), a.includes("gas")) {
    if ((ae = s.userOperation) != null && ae.estimateGas) {
      const R = await s.userOperation.estimateGas(d);
      d = {
        ...d,
        ...R
      };
    }
    if (typeof d.callGasLimit > "u" || typeof d.preVerificationGas > "u" || typeof d.verificationGasLimit > "u" || d.paymaster && typeof d.paymasterPostOpGasLimit > "u" || d.paymaster && typeof d.paymasterVerificationGasLimit > "u") {
      const R = await ke(o, di, "estimateUserOperationGas")({
        account: s,
      ...
      d = {
        ...d,
        callGasLimit: d.callGasLimit ?? R.callGasLimit,
        preVerificationGas: d.preVerificationGas ?? R.preVerificationGas,
        verificationGasLimit: d.verificationGasLimit ?? R.verificationGasLimit,
        paymasterPostOpGasLimit: d.paymasterPostOpGasLimit ?? R.paymasterPostOpGasLimit,
        paymasterVerificationGasLimit: d.paymasterVerificationGasLimit ?? R.paymasterVerificationGasLimit
      };
    }
  }
  if (a.includes("paymaster") && l && !c && !n.paymasterAndData && !ee) {
    const R = await l({
      chainId: await N(),
      entryPointAddress: s.entryPoint.address,
      context: p,
  ...
  return delete d.calls, delete d.parameters, delete d.paymasterContext, typeof d.paymaster != "string" && delete d.paymaster, d;
}
async function di(e, t) {
  ...
  if (!n && !t.sender)
    throw new nr();
  const i = n ? rr(n) : void 0, s = bs(a), o = i ? await ke(e, hr, "prepareUserOperation")({
    ...t,
    parameters: [
      "authorization",
      "factory",
  ...
  try {
    const c = [
      Yt(o),
      r ?? ((u = i == null ? void 0 : i.entryPoint) == null ? void 0 : u.address)
    ], f = await e.request({
...
function ou(e) {
  const t = { ...e };
  return e.actualGasCost && (t.actualGasCost = BigInt(e.actualGasCost)), e.actualGasUsed && (t.actualGasUsed = BigInt(e.actualGasUsed)), e.logs && (t.logs = e.logs.map((n) => ws(n))), e.receipt && (t.receipt = vs(t.receipt)), t;
}
async function li(e, { hash: t }) {
  const n = await e.request({
...
async function cu(e, t) {
  ...
  if (!n && !t.sender)
    throw new nr();
  const a = n ? rr(n) : void 0, i = a ? await ke(e, hr, "prepareUserOperation")(t) : t, s = t.signature || await ((u = a == null ? void 0 : a.signUserOperation) == null ? void 0 : u.call(a, i)), o = Yt({
    ...i,
    signature: s
  });
  try {
...
function uu(e, t) {
  ...
  return new Promise((u, c) => {
    const f = Es(o, { resolve: u, reject: c }, (l) => {
      const p = (m) => {
        y(), m(), f();
      }, d = i ? setTimeout(() => p(() => l.reject(new na({ hash: n }))), i) : void 0, y = ks(async () => {
        a && s >= a && (clearTimeout(d), p(() => l.reject(new na({ hash: n }))));
        try {
          const m = await ke(e, li, "getUserOperationReceipt")({ hash: n });
          p(() => l.resolve(m));
        } catch (m) {
          const b = m;
          b.name !== "UserOperationReceiptNotFoundError" && p(() => l.reject(b));
        } finally {
          clearTimeout(d);
        }
        s++;
...
function du(e) {
  return {
    ...
    getChainId: () => Pa(e),
    getSupportedEntryPoints: () => au(e),
    getUserOperation: (t) => su(e, t),
    getUserOperationReceipt: (t) => li(e, t),
    prepareUserOperation: (t) => hr(e, t),
    sendUserOperation: (t) => cu(e, t),
    waitForUserOperationReceipt: (t) => uu(e, t)
  };
}
function lu(e) {
  ...
  return Object.assign(Ss({
    ...
    transport: s,
    type: "bundlerClient"
  }), { client: t, paymaster: a, paymasterContext: i, userOperation: o }).extend(du);
}
const fu = "0x5FF137D4b0FDCD49DcA30c7CF57E578a026d2789", fi = ir(() => ({})), pu = [
  As,
  Vs,
  zs,
  Js,
  ...
  ...pu,
  ...mu
].reduce((e, t) => (e.set(t.id, t), e), /* @__PURE__ */ new Map());
function gr(e) {
  return yu.get(e);
}
function pi(e) {
  var n, r, a;
  const t = gr(e);
  if ((a = (r = (n = t == null ? void 0 : t.rpcUrls) == null ? void 0 : n.default) == null ? void 0 : r.http) != null && a[0])
...
function mi(e) {
  const { chainId: t, rpcUrl: n, nativeCurrency: r, viemChain: a } = e, i = hu(t, n, {
    viemChain: a,
    nativeCurrency: r
  }), s = Os({
    chain: i,
...
function yi(e, t) {
    ...
    [e]: {
      client: t.client,
      bundlerClient: t.bundlerClient
    }
  }));
}
function hi(e) {
  var r;
  const t = (r = fi.getState()[e]) == null ? void 0 : r.client;
  if (t)
    return t;
  const n = gu(e);
  if (n)
    return yi(e, n), n.client;
}
const bt = ir(() => ({
  correlationIds: /* @__PURE__ */ new Map()
})), xe = {
  get: (e) => bt.getState().correlationIds.get(e),
  set: (e, t) => {
    bt.setState((n) => {
...
function wt(e) {
  ...
  if ("address" in e && typeof e.address == "string" && !_t(e.address))
    throw k.rpc.internal("sub account address is invalid");
  if ("factory" in e && typeof e.factory == "string" && !_t(e.factory))
    throw k.rpc.internal("sub account factory address is invalid");
  if ("factoryData" in e && typeof e.factoryData == "string" && !Ge(e.factoryData))
...
async function xu(e, { iv: t, cipherText: n }) {
...
async function bi(e, t) {
  const n = gi(e), r = await crypto.subtle.exportKey(n, t);
  return wc(new Uint8Array(r));
}
async function wi(e, t) {
  const n = gi(e), r = vc(t).buffer;
...
async function ku(e, t) {
  return JSON.parse(await xu(t, e));
}
...
class q extends Error {
  constructor(t, n = {}) {
    ...
    })(), a = n.cause instanceof q && n.cause.docsPath || n.docsPath, s = `https://oxlib.sh${a ?? ""}`, o = [
      t || "An error occurred.",
...
`);
    super(o, n.cause ? { cause: n.cause } : void 0), Object.defineProperty(this, "details", {
      ...
      writable: !0,
      value: `ox@${Pu()}`
    }), this.cause = n.cause, this.details = r, this.docs = s, this.docsPath = a, this.shortMessage = t;
  }
  walk(t) {
    return vi(this, t);
  }
...
function vi(e, t) {
  return t != null && t(e) ? e : e && typeof e == "object" && "cause" in e && e.cause ? vi(e.cause, t) : t ? null : e;
}
/*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) */
const br = /* @__PURE__ */ BigInt(0), Qn = /* @__PURE__ */ BigInt(1);
function zt(e, t = "") {
  if (typeof e != "boolean") {
    const n = t && `"${t}"`;
...
function Ue(e, t, n = "") {
  const r = ar(e), a = e == null ? void 0 : e.length, i = t !== void 0;
  if (!r || i && a !== t) {
    const s = n && `"${n}" `, o = i ? ` of length ${t}` : "", u = r ? `length=${a}` : `type=${typeof e}`;
...
function Ei(e) {
  return Is(e), xi(Ve(Uint8Array.from(e).reverse()));
}
function wr(e, t) {
...
const an = (e) => typeof e == "bigint" && br <= e;
function Ou(e, t, n) {
...
function Si(e) {
  let t;
  for (t = 0; e > br; e >>= Qn, t += 1)
    ;
  return t;
}
const ft = (e) => (Qn << BigInt(e)) - Qn;
function Cu(e, t, n) {
  ...
  const r = (d) => new Uint8Array(d), a = (d) => Uint8Array.of(d);
  let i = r(e), s = r(e), o = 0;
  const u = () => {
    i.fill(1), s.fill(0), o = 0;
  }, c = (...d) => n(s, i, ...d), f = (d = r(0)) => {
    s = c(a(0), d), i = c(), d.length !== 0 && (s = c(a(1), d), i = c());
  }, l = () => {
    if (o++ >= 1e3)
...
const Tu = "#__bigint";
function Qt(e, t, n) {
  return JSON.stringify(e, (r, a) => typeof a == "bigint" ? a.toString() + Tu : a, n);
}
function _u(e, t) {
  if (Xe(e) > t)
    throw new Zu({
...
function Bu(e, t) {
  if (typeof t == "number" && t > 0 && t > Xe(e) - 1)
    throw new Ri({
      offset: t,
      position: "start",
      size: Xe(e)
...
function Ru(e, t, n) {
  if (typeof t == "number" && typeof n == "number" && Xe(e) !== n - t)
    throw new Ri({
      offset: n,
      position: "end",
      size: Xe(e)
...
function Uu(e, t) {
  if (typeof t == "number" && t > 0 && t > _e(e) - 1)
    throw new Ci({
      offset: t,
      position: "start",
      size: _e(e)
...
const ju = /* @__PURE__ */ new TextEncoder(), Du = /* @__PURE__ */ Array.from({ length: 256 }, (e, t) => t.toString(16).padStart(2, "0"));
function Mu(e, t = {}) {
  const { strict: n = !1 } = t;
  if (!e)
    throw new sa(e);
...
function Pi(e) {
  return e instanceof Uint8Array ? Ye(e) : Array.isArray(e) ? Ye(new Uint8Array(e)) : e;
}
function Ye(e, t = {}) {
  let n = "";
  for (let a = 0; a < e.length; a++)
    n += Du[e[a]];
  const r = `0x${n}`;
  return typeof t.size == "number" ? (xr(r, t.size), Ii(r, t.size)) : r;
}
function Ie(e, t = {}) {
...
function Oi(e, t = {}) {
  return Ye(ju.encode(e), t);
}
function Lu(e, t) {
  return Ai(e, { dir: "left", size: t });
}
function Ii(e, t) {
  return Ai(e, { dir: "right", size: t });
}
function pe(e, t, n, r = {}) {
  const { strict: a } = r;
  Uu(e, t);
...
function Fu(e, t = {}) {
  ...
  if (!n)
    return r;
  const a = (e.length - 2) / 2, i = (1n << BigInt(a) * 8n) - 1n, s = i >> 1n;
  return r <= s ? r : r - i - 1n;
}
function Gu(e, t = {}) {
  const { strict: n = !1 } = t;
  try {
    return Mu(e, { strict: n }), !0;
  } catch {
    return !1;
  }
}
...
class sa extends q {
  constructor(t) {
    super(`Value \`${typeof t == "object" ? Qt(t) : t}\` of type \`${typeof t}\` is an invalid hex type.`, {
...
function Ti(e) {
  return e instanceof Uint8Array ? e : typeof e == "string" ? Bi(e) : _i(e);
}
function _i(e) {
...
function Bi(e, t = {}) {
  ...
  for (let o = 0, u = 0; o < i; o++) {
    const c = ia(a.charCodeAt(u++)), f = ia(a.charCodeAt(u++));
    if (c === void 0 || f === void 0)
      throw new q(`Invalid byte sequence ("${a[u - 2]}${a[u - 1]}" in "${a}").`);
    s[o] = c * 16 + f;
  }
  return s;
}
...
class xt extends q {
  constructor(t) {
    super(`Value \`${typeof t == "object" ? Qt(t) : t}\` of type \`${typeof t}\` is an invalid Bytes value.`, {
...
function Ui(e, t = {}) {
  const { as: n = typeof e == "string" ? "Hex" : "Bytes" } = t, r = Cs(Ti(e));
  return n === "Bytes" ? r : Ye(r);
}
function Ni(e, t = {}) {
...
function Er(e, t = {}) {
  ...
  return $t(
    ...
    typeof a == "bigint" ? Ie(a, { size: 32 }) : "0x"
  );
}
class Yu extends q {
  constructor({ publicKey: t }) {
    super(`Value \`${Qt(t)}\` is not a valid public key.`, {
      metaMessages: [
...
const la = 2n ** 256n - 1n;
/*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) */
const de = BigInt(0), oe = BigInt(1), Ne = /* @__PURE__ */ BigInt(2), Di = /* @__PURE__ */ BigInt(3), Mi = /* @__PURE__ */ BigInt(4), Li = /* @__PURE__ */ BigInt(5), ed = /* @__PURE__ */ BigInt(7), Fi = /* @__PURE__ */ BigInt(8), td = /* @__PURE__ */ BigInt(9), Gi = /* @__PURE__ */ BigInt(16);
function ye(e, t) {
  const n = e % t;
  return n >= de ? n : t + n;
}
...
function Ki(e, t) {
  const n = (e.ORDER + oe) / Mi, r = e.pow(t, n);
  return kr(e, r, t), r;
}
function nd(e, t) {
  const n = (e.ORDER - Li) / Fi, r = e.mul(t, Ne), a = e.pow(r, n), i = e.mul(t, a), s = e.mul(e.mul(i, Ne), a), o = e.mul(i, e.sub(s, e.ONE));
  return kr(e, o, t), o;
}
function rd(e) {
  const t = Le(e), n = Hi(e), r = n(t, t.neg(t.ONE)), a = n(t, r), i = n(t, t.neg(r)), s = (e + ed) / Gi;
  return (o, u) => {
    let c = o.pow(u, s), f = o.mul(c, r);
    const l = o.mul(c, a), p = o.mul(c, i), d = o.eql(o.sqr(f), u), y = o.eql(o.sqr(l), u);
    c = o.cmov(c, f, d), f = o.cmov(p, l, y);
    const m = o.eql(o.sqr(f), u), b = o.cmov(c, f, m);
    return kr(o, b, u), b;
  };
}
function Hi(e) {
  ...
  return function(u, c) {
    ...
    if (pa(u, c) !== 1)
      throw new Error("Cannot find square root");
    let f = n, l = u.mul(u.ONE, i), p = u.pow(c, t), d = u.pow(c, s);
    for (; !u.eql(p, u.ONE); ) {
      if (u.is0(p))
        return u.ZERO;
      let y = 1, m = u.sqr(p);
      for (; !u.eql(m, u.ONE); )
        if (y++, m = u.sqr(m), y === f)
          throw new Error("Cannot find square root");
      const b = oe << BigInt(f - y - 1), E = u.pow(l, b);
      f = y, l = u.sqr(E), p = u.mul(p, l), d = u.mul(d, E);
    }
    return d;
  };
}
function ad(e) {
  return e % Mi === Di ? Ki : e % Fi === Li ? nd : e % Gi === td ? rd(e) : Hi(e);
}
const id = [
  "create",
  "isValid",
...
function sd(e) {
  const t = {
    ...
    BYTES: "number",
    BITS: "number"
  }, n = id.reduce((r, a) => (r[a] = "function", r), t);
  return vr(e, n), e;
}
function od(e, t, n) {
  if (n < de)
...
function zi(e, t, n = !1) {
  const r = new Array(t.length).fill(n ? e.ZERO : void 0), a = t.reduce((s, o, u) => e.is0(o) ? s : (r[u] = s, e.mul(s, o)), e.ONE), i = e.inv(a);
  return t.reduceRight((s, o, u) => e.is0(o) ? s : (r[u] = e.mul(s, r[u]), e.mul(s, o)), i), r;
}
function pa(e, t) {
  const n = (e.ORDER - oe) / Ne, r = e.pow(t, n), a = e.eql(r, e.ONE), i = e.eql(r, e.ZERO), s = e.eql(r, e.neg(e.ONE));
  if (!a && !i && !s)
...
function Le(e, t, n = !1, r = {}) {
  ...
  if (typeof t == "object" && t != null) {
    ...
    const p = t;
    p.BITS && (a = p.BITS), p.sqrt && (i = p.sqrt), typeof p.isLE == "boolean" && (n = p.isLE), typeof p.modFromBytes == "boolean" && (s = p.modFromBytes), o = p.allowedLengths;
  } else
    typeof t == "number" && (a = t), r.sqrt && (i = r.sqrt);
  const { nBitLength: u, nByteLength: c } = Vi(e, a);
  if (c > 2048)
  ...
  const l = Object.freeze({
    ...
    mulN: (p, d) => p * d,
    inv: (p) => fa(p, e),
    sqrt: i || ((p) => (f || (f = ad(e)), f(l, p))),
    toBytes: (p) => n ? ki(p, c) : wr(p, c),
    fromBytes: (p, d = !0) => {
      if (o) {
        if (!o.includes(p.length) || p.length > c)
          throw new Error("Field.fromBytes: expected " + o + " bytes, got " + p.length);
        const m = new Uint8Array(c);
        m.set(p, n ? 0 : m.length - p.length), p = m;
      }
      if (p.length !== c)
        throw new Error("Field.fromBytes: expected " + c + " bytes, got " + p.length);
      let y = n ? Ei(p) : Xt(p);
      if (s && (y = ye(y, e)), !d && !l.isValid(y))
        throw new Error("invalid field element: outside of range 0..ORDER");
      return y;
    },
    // TODO: we don't need it here, move out to separate fn
    invertBatch: (p) => zi(l, p),
...
function cd(e, t, n = !1) {
  const r = e.length, a = qi(t), i = Zi(t);
  if (r < 16 || r < i || r > 1024)
    throw new Error("expected " + i + "-1024 bytes of input, got " + r);
  const s = n ? Ei(e) : Xt(e), o = ye(s, t - oe) + oe;
  return n ? ki(o, a) : wr(o, a);
}
/*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) */
const Qe = BigInt(0), je = BigInt(1);
function Vt(e, t) {
  const n = t.negate();
  return e ? n : t;
}
function sn(e, t) {
  const n = zi(e.Fp, t.map((r) => r.Z));
...
const cn = /* @__PURE__ */ new WeakMap(), Ji = /* @__PURE__ */ new WeakMap();
function un(e) {
  return Ji.get(e) || 1;
}
function ya(e) {
...
class ld {
  ...
  _unsafeLadder(t, n, r = this.ZERO) {
    let a = t;
    for (; n > Qe; )
      n & je && (r = r.add(a)), a = a.double(), n >>= je;
    return r;
  }
  /**
  ...
  precomputeWindow(t, n) {
    const { windows: r, windowSize: a } = on(n, this.bits), i = [];
    let s = t, o = s;
    for (let u = 0; u < r; u++) {
      o = s, i.push(o);
      for (let c = 1; c < a; c++)
  ...
  wNAF(t, n, r) {
    ...
    const s = on(t, this.bits);
    for (let o = 0; o < s.windows; o++) {
      const { nextN: u, offset: c, isZero: f, isNeg: l, isNegF: p, offsetF: d } = ma(r, o, s);
      r = u, f ? i = i.add(Vt(p, n[d])) : a = a.add(Vt(l, n[c]));
    }
    return ya(r), { p: a, f: i };
  }
  /**
  ...
  wNAFUnsafe(t, n, r, a = this.ZERO) {
    const i = on(t, this.bits);
    for (let s = 0; s < i.windows && r !== Qe; s++) {
      const { nextN: o, offset: u, isZero: c, isNeg: f } = ma(r, s, i);
      if (r = o, !c) {
        const l = n[u];
        a = a.add(f ? l.negate() : l);
      }
    }
    return ya(r), a;
  }
  getPrecomputes(t, n, r) {
    let a = cn.get(n);
    return a || (a = this.precomputeWindow(n, t), t !== 1 && (typeof r == "function" && (a = r(a)), cn.set(n, a))), a;
  }
  cached(t, n, r) {
    const a = un(t);
  ...
  createCache(t, n) {
    Wi(n, this.bits), Ji.set(t, n), cn.delete(t);
  }
  hasCache(t) {
    return un(t) !== 1;
  }
...
function fd(e, t, n, r) {
  ...
  for (; n > Qe || r > Qe; )
    n & je && (i = i.add(a)), r & je && (s = s.add(a)), a = a.double(), n >>= je, r >>= je;
  return { p1: i, p2: s };
}
function pd(e, t, n, r) {
  ud(n, e), dd(r, t);
  ...
  const s = e.ZERO, o = Si(BigInt(a));
  let u = 1;
  o > 12 ? u = o - 3 : o > 4 ? u = o - 2 : o > 0 && (u = 2);
  const c = ft(u), f = new Array(Number(c) + 1).fill(s), l = Math.floor((t.BITS - 1) / u) * u;
  let p = s;
  for (let d = l; d >= 0; d -= u) {
    f.fill(s);
    for (let m = 0; m < i; m++) {
      const b = r[m], E = Number(b >> BigInt(d) & c);
      f[E] = f[E].add(n[m]);
    }
    let y = s;
    for (let m = f.length - 1, b = s; m > 0; m--)
      b = b.add(f[m]), y = y.add(b);
    if (p = p.add(y), d !== 0)
      for (let m = 0; m < u; m++)
        p = p.double();
  }
...
function md(e, t, n = {}, r) {
  ...
  for (const u of ["p", "n", "h"]) {
    const c = t[u];
    if (!(typeof c == "bigint" && c > Qe))
      throw new Error(`CURVE.${u} must be positive bigint`);
  }
  const a = ha(t.p, n.Fp, r), i = ha(t.n, n.Fn, r), o = ["Gx", "Gy", "a", "b"];
  for (const u of o)
    if (!a.isValid(t[u]))
...
/*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) */
const ga = (e, t) => (e + (e >= 0 ? t : -t) / Yi) / t;
function yd(e, t, n) {
  const [[r, a], [i, s]] = t, o = ga(s * e, n), u = ga(-a * e, n);
  let c = e - o * r - u * i, f = -o * a - u * s;
  const l = c < Se, p = f < Se;
  l && (c = -c), p && (f = -f);
  const d = ft(Math.ceil(Si(n) / 2)) + Ze;
  if (c < Se || c >= d || f < Se || f >= d)
...
function dn(e, t) {
  ...
  return zt(n.lowS, "lowS"), zt(n.prehash, "prehash"), n.format !== void 0 && $n(n.format), n;
}
...
const Ee = {
  ...
  _tlv: {
    encode: (e, t) => {
      ...
      const r = t.length / 2, a = vt(r);
      if (a.length / 2 & 128)
        throw new n("tlv.encode: long form length too big");
      const i = r > 127 ? vt(a.length / 2 | 128) : "";
      return vt(e) + i + a + t;
    },
  ...
  toSig(e) {
    const { Err: t, _int: n, _tlv: r } = Ee, a = ue("signature", e), { v: i, l: s } = r.decode(48, a);
    if (s.length)
      throw new t("invalid signature: left bytes after parsing");
    const { v: o, l: u } = r.decode(2, i), { v: c, l: f } = r.decode(2, u);
    if (f.length)
      throw new t("invalid signature: left bytes after parsing");
    return { r: n.decode(o), s: n.decode(c) };
  },
  hexFromSig(e) {
    const { _tlv: t, _int: n } = Ee, r = t.encode(2, n.encode(e.r)), a = t.encode(2, n.encode(e.s)), i = r + a;
    return t.encode(48, i);
  }
}, Se = BigInt(0), Ze = BigInt(1), Yi = BigInt(2), Et = BigInt(3), gd = BigInt(4);
function He(e, t) {
  const { BYTES: n } = e;
  let r;
  if (typeof t == "bigint")
...
function bd(e, t = {}) {
  const n = md("weierstrass", e, t), { Fp: r, Fn: a } = n;
  let i = n.CURVE;
  const { h: s, n: o } = i;
  vr(t, {}, {
  ...
  function l(L, w, g) {
    const { x: h, y: S } = w.toAffine(), A = r.toBytes(h);
    if (zt(g, "isCompressed"), g) {
      f();
      const C = !r.isOdd(S);
      return Pe(Xi(C), A);
    } else
      return Pe(Uint8Array.of(4), A, r.toBytes(S));
  }
  function p(L) {
    Ue(L, void 0, "Point");
    const { publicKey: w, publicKeyUncompressed: g } = c, h = L.length, S = L[0], A = L.subarray(1);
    if (h === w && (S === 2 || S === 3)) {
      const C = r.fromBytes(A);
      if (!r.isValid(C))
      ...
      try {
        ...
        const V = ne instanceof Error ? ": " + ne.message : "";
        throw new Error("bad point: is not on curve, sqrt error" + V);
      }
      f();
      const T = r.isOdd(O);
      return (S & 1) === 1 !== T && (O = r.neg(O)), { x: C, y: O };
    } else if (h === g && S === 4) {
      const C = r.BYTES, I = r.fromBytes(A.subarray(0, C)), O = r.fromBytes(A.subarray(C, C * 2));
      if (!b(I, O))
        throw new Error("bad point: is not on curve");
      return { x: I, y: O };
    } else
      throw new Error(`bad point: got length ${h}, expected compressed=${w} or uncompressed=${g}`);
  }
  const d = t.toBytes || l, y = t.fromBytes || p;
  function m(L) {
    const w = r.sqr(L), g = r.mul(w, L);
    return r.add(r.add(g, r.mul(L, i.a)), i.b);
  }
  function b(L, w) {
    const g = r.sqr(w), h = m(L);
    return r.eql(g, h);
  }
  if (!b(i.Gx, i.Gy))
    throw new Error("bad curve params: generator point");
  const E = r.mul(r.pow(i.a, Et), gd), v = r.mul(r.sqr(i.b), BigInt(27));
  if (r.is0(r.add(E, v)))
    throw new Error("bad curve params: a or b");
  function P(L, w, g = !1) {
    if (!r.isValid(w) || g && r.is0(w))
  ...
  const ae = aa((L, w) => {
    ...
    if (r.eql(S, r.ONE))
      return { x: g, y: h };
    const A = L.is0();
    w == null && (w = A ? r.ONE : r.inv(S));
    const C = r.mul(g, w), I = r.mul(h, w), O = r.mul(S, w);
    if (A)
    ...
    const { x: w, y: g } = L.toAffine();
    if (!r.isValid(w) || !r.isValid(g))
  ...
  function j(L, w, g, h, S) {
    return g = new B(r.mul(g.X, L), g.Y, g.Z), w = Vt(h, w), g = Vt(S, g), w.add(g);
  }
  class B {
    /** Does NOT validate if the point is valid. Use `.assertValidity()`. */
    constructor(w, g, h) {
      this.X = P("x", w), this.Y = P("y", g, !0), this.Z = P("z", h), Object.freeze(this);
    }
    static CURVE() {
      return i;
    }
    ...
    static fromAffine(w) {
      const { x: g, y: h } = w || {};
      if (!w || !r.isValid(g) || !r.isValid(h))
        throw new Error("invalid affine point");
      if (w instanceof B)
        throw new Error("projective point not allowed");
      return r.is0(g) && r.is0(h) ? B.ZERO : new B(g, h, r.ONE);
    }
    static fromBytes(w) {
      const g = B.fromAffine(y(Ue(w, void 0, "point")));
      return g.assertValidity(), g;
    }
    static fromHex(w) {
      return B.fromBytes(ue("pointHex", w));
    }
    get x() {
     ...
     */
    precompute(w = 8, g = !0) {
      return le.createCache(this, w), g || this.multiply(Et), this;
    }
    // TODO: return `this`
    ...
    equals(w) {
      N(w);
      const { X: g, Y: h, Z: S } = this, { X: A, Y: C, Z: I } = w, O = r.eql(r.mul(g, I), r.mul(A, S)), T = r.eql(r.mul(h, I), r.mul(C, S));
      return O && T;
    }
    ...
    double() {
      const { a: w, b: g } = i, h = r.mul(g, Et), { X: S, Y: A, Z: C } = this;
      let I = r.ZERO, O = r.ZERO, T = r.ZERO, U = r.mul(S, S), ne = r.mul(A, A), V = r.mul(C, C), D = r.mul(S, A);
      return D = r.add(D, D), T = r.mul(S, C), T = r.add(T, T), I = r.mul(w, T), O = r.mul(h, V), O = r.add(I, O), I = r.sub(ne, O), O = r.add(ne, O), O = r.mul(I, O), I = r.mul(D, I), T = r.mul(h, T), V = r.mul(w, V), D = r.sub(U, V), D = r.mul(w, D), D = r.add(D, T), T = r.add(U, U), U = r.add(T, U), U = r.add(U, V), U = r.mul(U, D), O = r.add(O, U), V = r.mul(A, C), V = r.add(V, V), U = r.mul(V, D), I = r.sub(I, U), T = r.mul(V, ne), T = r.add(T, T), T = r.add(T, T), new B(I, O, T);
    }
    ...
    add(w) {
      N(w);
      const { X: g, Y: h, Z: S } = this, { X: A, Y: C, Z: I } = w;
      let O = r.ZERO, T = r.ZERO, U = r.ZERO;
      const ne = i.a, V = r.mul(i.b, Et);
      let D = r.mul(g, A), W = r.mul(h, C), re = r.mul(S, I), ce = r.add(g, h), J = r.add(A, C);
      ce = r.mul(ce, J), J = r.add(D, W), ce = r.sub(ce, J), J = r.add(g, S);
      let ie = r.add(A, I);
      return J = r.mul(J, ie), ie = r.add(D, re), J = r.sub(J, ie), ie = r.add(h, S), O = r.add(C, I), ie = r.mul(ie, O), O = r.add(W, re), ie = r.sub(ie, O), U = r.mul(ne, J), O = r.mul(V, re), U = r.add(O, U), O = r.sub(W, U), U = r.add(W, U), T = r.mul(O, U), W = r.add(D, D), W = r.add(W, D), re = r.mul(ne, re), J = r.mul(V, J), W = r.add(W, re), re = r.sub(D, re), re = r.mul(ne, re), J = r.add(J, re), D = r.mul(W, J), T = r.add(T, D), D = r.mul(ie, J), O = r.mul(ce, O), O = r.sub(O, D), D = r.mul(ce, W), U = r.mul(ie, U), U = r.add(U, D), new B(O, T, U);
    }
    subtract(w) {
    ...
    multiply(w) {
      ...
      let h, S;
      const A = (C) => le.cached(this, C, (I) => sn(B, I));
      if (g) {
        const { k1neg: C, k1: I, k2neg: O, k2: T } = ee(w), { p: U, f: ne } = A(I), { p: V, f: D } = A(T);
        S = ne.add(D), h = j(g.beta, U, V, C, O);
      } else {
        const { p: C, f: I } = A(w);
        h = C, S = I;
      }
    ...
    multiplyUnsafe(w) {
      ...
      if (g) {
        const { k1neg: S, k1: A, k2neg: C, k2: I } = ee(w), { p1: O, p2: T } = fd(B, h, A, I);
        return j(g.beta, O, T, S, C);
      } else
        return le.unsafe(h, w);
    }
    multiplyAndAddUnsafe(w, g, h) {
      const S = this.multiplyUnsafe(g).add(w.multiplyUnsafe(h));
     ...
     */
    isTorsionFree() {
      const { isTorsionFree: w } = t;
      return s === Ze ? !0 : w ? w(B, this) : le.unsafe(this, o).is0();
    }
    clearCofactor() {
      const { clearCofactor: w } = t;
      return s === Ze ? this : w ? w(B, this) : this.multiplyUnsafe(s);
    }
    isSmallOrder() {
      return this.multiplyUnsafe(s).is0();
    }
    toBytes(w = !0) {
      return zt(w, "isCompressed"), this.assertValidity(), d(B, this, w);
    }
    toHex(w = !0) {
      return Ve(this.toBytes(w));
    }
    toString() {
    ...
    static fromPrivateKey(w) {
      return B.BASE.multiply(He(a, w));
    }
  }
  B.BASE = new B(i.Gx, i.Gy, r.ONE), B.ZERO = new B(r.ZERO, r.ONE, r.ZERO), B.Fp = r, B.Fn = a;
  const se = a.BITS, le = new ld(B, t.endo ? Math.ceil(se / 2) : se);
...
function wd(e, t = {}) {
  const { Fn: n } = e, r = t.randomBytes || Oa, a = Object.assign(Qi(e.Fp, n), { seed: Zi(n.ORDER) });
  function i(d) {
    try {
      return !!He(n, d);
    } catch {
  ...
  function s(d, y) {
    const { publicKey: m, publicKeyUncompressed: b } = a;
    try {
      const E = d.length;
      return y === !0 && E !== m || y === !1 && E !== b ? !1 : !!e.fromBytes(d);
    } catch {
      return !1;
    }
  }
  function o(d = r(a.seed)) {
    return cd(Ue(d, a.seed, "seed"), n.ORDER);
  }
  function u(d, y = !0) {
    return e.BASE.multiply(He(n, d)).toBytes(y);
  }
  function c(d) {
    const y = o(d);
  ...
  function f(d) {
    ...
    if (d instanceof e)
      return !0;
    const { secretKey: y, publicKey: m, publicKeyUncompressed: b } = a;
    if (n.allowedLengths || y === m)
      return;
    const E = ue("key", d).length;
    return E === m || E === b;
  }
  function l(d, y, m = !0) {
    if (f(d) === !0)
    ...
    const b = He(n, d);
    return e.fromHex(y).multiply(b).toBytes(m);
  }
  return Object.freeze({ getPublicKey: u, getSharedSecret: l, keygen: c, Point: e, utils: {
    isValidSecretKey: i,
    isValidPublicKey: s,
    randomSecretKey: o,
    // TODO: remove
    isValidPrivateKey: i,
    randomPrivateKey: o,
    normPrivateKeyToScalar: (d) => He(n, d),
    precompute(d = 8, y = e.BASE) {
      return y.precompute(d, !1);
    }
  }, lengths: a });
}
function vd(e, t, n = {}) {
  ...
  const r = n.randomBytes || Oa, a = n.hmac || ((g, ...h) => Bs(t, g, Pe(...h))), { Fp: i, Fn: s } = e, { ORDER: o, BITS: u } = s, { keygen: c, getPublicKey: f, getSharedSecret: l, utils: p, lengths: d } = wd(e, n), y = {
    prehash: !1,
  ...
  function v(g, h) {
    $n(h);
    const S = d.signature, A = h === "compact" ? S : h === "recovered" ? S + 1 : void 0;
    return Ue(g, A, `${h} signature`);
  }
  class P {
    constructor(h, S, A) {
      this.r = E("r", h), this.s = E("s", S), A != null && (this.recovery = A), Object.freeze(this);
    }
    static fromBytes(h, S = m) {
      v(h, S);
      let A;
      if (S === "der") {
        const { r: T, s: U } = Ee.toSig(Ue(h));
        return new P(T, U);
      }
      S === "recovered" && (A = h[0], S = "compact", h = h.subarray(1));
      const C = s.BYTES, I = h.subarray(0, C), O = h.subarray(C, C * 2);
      return new P(s.fromBytes(I), s.fromBytes(O), A);
    }
    static fromHex(h, S) {
      return this.fromBytes(Bt(h), S);
    }
    addRecoveryBit(h) {
      return new P(this.r, this.s, h);
    }
    recoverPublicKey(h) {
      const S = i.ORDER, { r: A, s: C, recovery: I } = this;
      if (I == null || ![0, 1, 2, 3].includes(I))
        throw new Error("recovery id invalid");
      if (o * Yi < S && I > 1)
        throw new Error("recovery id is ambiguous for h>1 curve");
      const T = I === 2 || I === 3 ? A + o : A;
      if (!i.isValid(T))
        throw new Error("recovery id 2 or 3 invalid");
      const U = i.toBytes(T), ne = e.fromBytes(Pe(Xi((I & 1) === 0), U)), V = s.inv(T), D = ee(ue("msgHash", h)), W = s.create(-D * V), re = s.create(C * V), ce = e.BASE.multiplyUnsafe(W).add(ne.multiplyUnsafe(re));
      if (ce.is0())
    ...
    toBytes(h = m) {
      if ($n(h), h === "der")
        return Bt(Ee.hexFromSig(this));
      const S = s.toBytes(this.r), A = s.toBytes(this.s);
      if (h === "recovered") {
        if (this.recovery == null)
          throw new Error("recovery bit must be present");
        return Pe(Uint8Array.of(this.recovery), S, A);
      }
      return Pe(S, A);
    }
    toHex(h) {
    ...
    static fromCompact(h) {
      return P.fromBytes(ue("sig", h), "compact");
    }
    static fromDER(h) {
      return P.fromBytes(ue("sig", h), "der");
    }
    normalizeS() {
  ...
  const N = n.bits2int || function(h) {
    if (h.length > 8192)
      throw new Error("input is too large");
    const S = Xt(h), A = h.length * 8 - u;
    return A > 0 ? S >> BigInt(A) : S;
  }, ee = n.bits2int_modN || function(h) {
    return s.create(N(h));
  }, ae = ft(u);
  function R(g) {
    return Iu("num < 2^" + u, g, Se, ae), s.toBytes(g);
  }
  function j(g, h) {
    return Ue(g, void 0, "message"), h ? Ue(t(g), void 0, "prehashed message") : g;
  }
  function B(g, h, S) {
    if (["recovered", "canonical"].some((W) => W in S))
      throw new Error("sign() legacy options not supported");
    const { lowS: A, prehash: C, extraEntropy: I } = dn(S, y);
    g = j(g, C);
    const O = ee(g), T = He(s, h), U = [R(T), R(O)];
    if (I != null && I !== !1) {
      const W = I === !0 ? r(d.secretKey) : I;
      U.push(ue("extraEntropy", W));
    }
    const ne = Pe(...U), V = O;
    function D(W) {
      const re = N(W);
      if (!s.isValidNot0(re))
        return;
      const ce = s.inv(re), J = e.BASE.multiply(re).toAffine(), ie = s.create(J.x);
      if (ie === Se)
        return;
      const pt = s.create(ce * s.create(V + ie * T));
      if (pt === Se)
        return;
      let Ir = (J.x === ie ? 0 : 2) | Number(J.y & Ze), Cr = pt;
      return A && b(pt) && (Cr = s.neg(pt), Ir ^= 1), new P(ie, Cr, Ir);
    }
    return { seed: ne, k2sig: D };
  }
  function se(g, h, S = {}) {
    g = ue("message", g);
    const { seed: A, k2sig: C } = B(g, h, S);
    return Cu(t.outputLen, s.BYTES, a)(A, C);
  }
  function le(g) {
    let h;
    const S = typeof g == "string" || ar(g), A = !S && g !== null && typeof g == "object" && typeof g.r == "bigint" && typeof g.s == "bigint";
    if (!S && !A)
    ...
    if (A)
      ...
      try {
        h = P.fromBytes(ue("sig", g), "der");
      } catch (C) {
        if (!(C instanceof Ee.Err))
          throw C;
      }
      if (!h)
        try {
          h = P.fromBytes(ue("sig", g), "compact");
        } catch {
          return !1;
        }
    }
  ...
  function L(g, h, S, A = {}) {
    const { lowS: C, prehash: I, format: O } = dn(A, y);
    if (S = ue("publicKey", S), h = j(ue("message", h), I), "strict" in A)
      throw new Error("options.strict was renamed to lowS");
    const T = O === void 0 ? le(g) : P.fromBytes(ue("sig", g), O);
    if (T === !1)
      return !1;
    try {
      const U = e.fromBytes(S);
      if (C && T.hasHighS())
        return !1;
      const { r: ne, s: V } = T, D = ee(h), W = s.inv(V), re = s.create(D * W), ce = s.create(ne * W), J = e.BASE.multiplyUnsafe(re).add(U.multiplyUnsafe(ce));
      return J.is0() ? !1 : s.create(J.x) === ne;
    } catch {
      return !1;
    }
  }
  function w(g, h, S = {}) {
    const { prehash: A } = dn(S, y);
    return h = j(h, A), P.fromBytes(g, "recovered").recoverPublicKey(h).toBytes();
  }
...
function Ed(e) {
  const { CURVE: t, curveOpts: n } = xd(e), r = {
    hmac: e.hmac,
...
function kd(e, t) {
  ...
  return Object.assign({}, t, {
    ProjectivePoint: n,
    CURVE: Object.assign({}, e, Vi(n.Fn.ORDER, n.Fn.BITS))
  });
}
function Sd(e) {
  const { CURVE: t, curveOpts: n, hash: r, ecdsaOpts: a } = Ed(e), i = bd(t, n), s = vd(i, r, a);
  return kd(e, s);
}
/*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) */
function Sr(e, t) {
  const n = (r) => Sd({ ...e, hash: r });
  return { ...n(t), create: n };
}
function Ad(e, t = {}) {
  const { recovered: n } = t;
  if (typeof e.r > "u")
    throw new ln({ signature: e });
  if (typeof e.s > "u")
    throw new ln({ signature: e });
  if (n && typeof e.yParity > "u")
    throw new ln({ signature: e });
  if (e.r < 0n || e.r > la)
    throw new Td({ value: e.r });
  if (e.s < 0n || e.s > la)
    throw new _d({ value: e.s });
  if (typeof e.yParity == "number" && e.yParity !== 0 && e.yParity !== 1)
    throw new Ar({ value: e.yParity });
}
function $i(e) {
  if (e.length !== 130 && e.length !== 132)
    throw new Cd({ signature: e });
...
function Pd(e) {
  ...
  return $t(
    ...
    typeof e.yParity == "number" ? Ie(Id(e.yParity), { size: 1 }) : "0x"
  );
}
function Od(e) {
  if (e === 0 || e === 27)
...
class ln extends q {
  constructor({ signature: t }) {
    super(`Signature \`${Qt(t)}\` is missing either an \`r\`, \`s\`, or \`yParity\` property.`), Object.defineProperty(this, "name", {
      enumerable: !0,
      configurable: !0,
      writable: !0,
...
const Rd = /* @__PURE__ */ new TextDecoder(), kt = /* @__PURE__ */ Object.fromEntries(Array.from("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/").map((e, t) => [t, e.charCodeAt(0)]));
({
...
function Ud(e, t = {}) {
  ...
  for (let u = 0, c = 0; c < e.length; u += 4, c += 3) {
    const f = (e[c] << 16) + (e[c + 1] << 8) + (e[c + 2] | 0);
    a[u] = kt[f >> 18], a[u + 1] = kt[f >> 12 & 63], a[u + 2] = kt[f >> 6 & 63], a[u + 3] = kt[f & 63];
  }
  const i = e.length % 3, s = Math.floor(e.length / 3) * 4 + (i && i + 1);
  let o = Rd.decode(new Uint8Array(a.buffer, 0, s));
  return n && i === 1 && (o += "=="), n && i === 2 && (o += "="), r && (o = o.replaceAll("+", "-").replaceAll("/", "_")), o;
}
function Nd(e, t = {}) {
  return Ud(Bi(e), t);
}
...
}, jd = Le(es.p), Dd = Le(ts.p), Md = Le(ns.p), Ld = Sr({ ...es, Fp: jd, lowS: !1 }, Rs);
Sr({ ...ts, Fp: Dd, lowS: !1 }, Us);
Sr({ ...ns, Fp: Md, lowS: !1, allowedPrivateKeyLengths: [130, 131, 132] }, Ns);
/*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) */
const ba = Ld;
Uint8Array.from([
  105,
...
function Fd(e = {}) {
  const { flag: t = 5, rpId: n = window.location.hostname, signCount: r = 0 } = e, a = Ui(Oi(n)), i = Ie(t, { size: 1 }), s = Ie(r, { size: 4 });
  return $t(a, i, s);
}
function Gd(e) {
...
function Kd(e) {
  const { challenge: t, crossOrigin: n, extraClientData: r, flag: a, origin: i, rpId: s, signCount: o, userVerification: u = "required" } = e, c = Fd({
    flag: a,
    rpId: s,
    signCount: o
  }), f = Gd({
    ...
    extraClientData: r,
    origin: i
  }), l = Ui(Oi(f)), p = f.indexOf('"challenge"'), d = f.indexOf('"type"'), y = {
    authenticatorData: c,
    clientDataJSON: f,
    challengeIndex: p,
    typeIndex: d,
  ...
  return { metadata: y, payload: m };
}
async function Hd(e = {}) {
  const { extractable: t = !1 } = e, n = await globalThis.crypto.subtle.generateKey({
    name: "ECDSA",
    namedCurve: "P-256"
  }, t, ["sign", "verify"]), r = await globalThis.crypto.subtle.exportKey("raw", n.publicKey), a = Wu(new Uint8Array(r));
  return {
...
async function zd(e) {
  const { payload: t, privateKey: n } = e, r = await globalThis.crypto.subtle.sign({
    name: "ECDSA",
    hash: "SHA-256"
  }, n, Ti(t)), a = _i(new Uint8Array(r)), i = ua(ca(a, 0, 32));
  let s = ua(ca(a, 32, 64));
  return s > ba.CURVE.n / 2n && (s = ba.CURVE.n - s), { r: i, s };
}
function en(e) {
...
let fn;
function Pr() {
  return fn || (fn = rs("keyval-store", "keyval")), fn;
}
function Vd(e, t = Pr()) {
  return t("readonly", (n) => en(n.get(e)));
}
function qd(e, t, n = Pr()) {
  return n("readwrite", (r) => (r.put(t, e), en(r.transaction)));
}
function Zd(e, t = Pr()) {
  return t("readwrite", (n) => (n.delete(e), en(n.transaction)));
}
function Wd(e, t) {
  const n = typeof indexedDB < "u" ? rs(e, t) : void 0;
  return {
    getItem: async (r) => {
      const a = await Vd(r, n);
      return a || null;
    },
    removeItem: async (r) => Zd(r, n),
    setItem: async (r, a) => qd(r, a, n)
  };
}
const Jd = "base-acc-sdk", Yd = "keys", Or = "activeId", $e = Wd(Jd, Yd);
async function Xd() {
  const e = await Hd({ extractable: !1 }), t = pe(Er(e.publicKey), 1);
  return await $e.setItem(t, e), await $e.setItem(Or, t), e;
}
async function Qd() {
  const e = await $e.getItem(Or);
  if (!e)
    return null;
  const t = await $e.getItem(e);
  return t || null;
}
async function $d() {
  const e = await Qd();
  if (!e) {
    const t = await Xd(), n = pe(Er(t.publicKey), 1);
    return await $e.setItem(n, t), await $e.setItem(Or, n), t;
  }
  return e;
}
async function el() {
  const e = await $d(), t = pe(Er(e.publicKey), 1), n = async (r) => {
    const { payload: a, metadata: i } = Kd({
      challenge: r,
...
class tl {
  constructor() {
    F(this, "ownPrivateKey", null);
    F(this, "ownPublicKey", null);
    F(this, "peerPublicKey", null);
    F(this, "sharedSecret", null);
  }
  ...
  async setPeerPublicKey(t) {
    this.sharedSecret = null, this.peerPublicKey = t, await this.storeKey(xa, t), await this.loadKeysIfNeeded();
  }
  async clear() {
    this.ownPrivateKey = null, this.ownPublicKey = null, this.peerPublicKey = null, this.sharedSecret = null, x.keys.clear();
  }
  async generateKeyPair() {
    const t = await bu();
    this.ownPrivateKey = t.privateKey, this.ownPublicKey = t.publicKey, await this.storeKey(wa, t.privateKey), await this.storeKey(va, t.publicKey);
  }
  async loadKeysIfNeeded() {
    if (this.ownPrivateKey === null && (this.ownPrivateKey = await this.loadKey(wa)), this.ownPublicKey === null && (this.ownPublicKey = await this.loadKey(va)), (this.ownPrivateKey === null || this.ownPublicKey === null) && await this.generateKeyPair(), this.peerPublicKey === null && (this.peerPublicKey = await this.loadKey(xa)), this.sharedSecret === null) {
      if (this.ownPrivateKey === null || this.peerPublicKey === null)
        return;
      this.sharedSecret = await wu(this.ownPrivateKey, this.peerPublicKey);
    }
  }
  // storage methods
  async loadKey(t) {
    const n = x.keys.get(t.storageKey);
    return n ? wi(t.keyType, n) : null;
  }
  async storeKey(t, n) {
    const r = await bi(t.keyType, n);
...
function rl(e) {
  if (!e || !Array.isArray(e) || e.length !== 1 && e.length !== 2 || typeof e[0] != "string" || !_t(e[0]))
    throw k.rpc.invalidParams();
  if (e.length === 2) {
...
function lt(e, t) {
  ...
  if (t && e.method.startsWith("wallet_")) {
    let r = st(n, "params.0.capabilities");
    if (typeof r > "u" && (r = {}), typeof r != "object")
      throw k.rpc.invalidParams();
    r = {
      ...t,
      ...r
    }, n.params && Array.isArray(n.params) && (n.params[0] = {
      ...n.params[0],
      capabilities: r
    });
  }
...
async function tr() {
  const e = x.subAccountsConfig.get() ?? {}, t = {};
...
async function as({ client: e, id: t }) {
  var r;
  const n = await _a(e, {
    id: t
  });
...
function is({ calls: e, from: t, chainId: n, capabilities: r }) {
  const a = Na.get().paymasterUrls;
  let i = {
...
async function sl() {
  ...
  return await new Promise((n, r) => {
    ur({ dialogContext: "sub_account_insufficient_balance" }), e.presentItem({
      ...
      onClose: () => {
        Ka({ dialogContext: "sub_account_insufficient_balance" }), e.clear(), r(new Error("User cancelled funding"));
      },
      actionItems: [
        {
        ...
        },
        {
          ...
          onClick: () => {
            De({
              dialogContext: "sub_account_insufficient_balance",
              dialogAction: "cancel"
            }), e.clear(), r(new Error("User cancelled funding"));
          }
        }
      ]
    });
...
function ol(e) {
  return typeof e == "object" && e !== null && Array.isArray(e) && e.length > 0 && typeof e[0] == "object" && e[0] !== null && "calls" in e[0];
}
function cl(e) {
  return Array.isArray(e) && e.length === 1 && typeof e[0] == "object" && e[0] !== null && "to" in e[0];
}
function ul(e) {
  return js(ve(qe(e)), 0, 16);
}
function dl({ attribution: e, dappOrigin: t }) {
  if (e) {
...
function fl({ webauthn: e, signature: t, id: n }) {
  const r = $i(t);
  return {
    id: n,
    rawId: Pt(Br(n)),
    response: {
      authenticatorData: Pt(yn(e.authenticatorData)),
      clientDataJSON: Pt(Br(e.clientDataJSON)),
      signature: Pt(pl(r.r, r.s))
    },
    type: JSON.parse(e.clientDataJSON).type
  };
}
function pl(e, t) {
  const n = yn(Rr(M(e))), r = yn(Rr(M(t))), a = n.length, i = r.length, s = a + i + 4, o = new Uint8Array(s + 2);
  return o[0] = 48, o[1] = s, o[2] = 2, o[3] = a, o.set(n, 4), o[a + 4] = 2, o[a + 5] = i, o.set(r, a + 6), o;
}
async function ml(e) {
  const { owner: t, ownerIndex: n, address: r, client: a, factoryData: i } = e, s = {
    abi: Fc,
    address: fu,
    version: "0.6"
  }, o = {
  ...
  return zc({
    ...
    async decodeCalls(u) {
      ...
      if (c.functionName === "execute")
        return [{ to: c.args[0], value: c.args[1], data: c.args[2] }];
      if (c.functionName === "executeBatch")
        return c.args[0].map((f) => ({
          to: f.target,
          value: f.value,
          data: f.data
        }));
      throw new _(`unable to decode calls for "${c.functionName}"`);
    },
    async encodeCalls(u) {
      return u.length === 1 ? Te({
        abi: he,
        functionName: "execute",
        args: [u[0].to, u[0].value ?? BigInt(0), u[0].data ?? "0x"]
      }) : Te({
        abi: he,
    ...
    async sign(u) {
      const c = await this.getAddress(), f = pn({
        address: c,
        chainId: a.chain.id,
        hash: u.hash
      }), l = await Ot({ hash: f, owner: t });
      return at({
        ownerIndex: n,
        signature: l
      });
    ...
    async signMessage(u) {
      const { message: c } = u, f = await this.getAddress(), l = pn({
        address: f,
        chainId: a.chain.id,
        hash: Ia(c)
      }), p = await Ot({ hash: l, owner: t });
      return at({
        ownerIndex: n,
        signature: p
      });
    ...
    async signTypedData(u) {
      const { domain: c, types: f, primaryType: l, message: p } = u, d = await this.getAddress(), y = pn({
        address: d,
        chainId: a.chain.id,
        hash: qt({
          domain: c,
    ...
    async signUserOperation(u) {
      const { chainId: c = a.chain.id, ...f } = u, l = await this.getAddress(), p = Hc({
        chainId: c,
    ...
    userOperation: {
      async estimateGas(u) {
        if (t.type === "webAuthn")
          return {
            verificationGasLimit: BigInt(Math.max(Number(u.verificationGasLimit ?? BigInt(0)), 8e5))
          };
      }
    }
  });
}
async function Ot({ hash: e, owner: t }) {
  if (t.type === "webAuthn") {
    const { signature: n, webauthn: r } = await t.sign({
      hash: e
    });
    return yl({ signature: n, webauthn: r });
  }
  if (t.sign)
    return t.sign({ hash: e });
  throw new _("`owner` does not support raw sign.");
}
function pn({ address: e, chainId: t, hash: n }) {
  return qt({
    domain: {
      chainId: t,
...
function yl({ webauthn: e, signature: t }) {
  const { r: n, s: r } = $i(t);
  return ot([
    {
      components: [
...
function at(e) {
  const { ownerIndex: t = 0 } = e, n = (() => {
    if (Ms(e.signature) !== 65)
      return e.signature;
    const r = Ks(e.signature);
    return Hs(["bytes32", "bytes32", "uint8"], [r.r, r.s, r.yParity === 0 ? 27 : 28]);
  })();
  return ot([
    {
      components: [
...
async function hl({ address: e, client: t, factory: n, factoryData: r, owner: a, ownerIndex: i, parentAddress: s, attribution: o }) {
  var p;
  const u = {
    address: e,
    factory: n,
    ...
    try {
      switch (d.method) {
        ...
        case "eth_sendTransaction": {
          Ae(d.params);
          const m = d.params[0];
          me(m.to, k.rpc.invalidParams("to is required"));
          const b = {
            to: m.to,
            data: On(m.data ?? "0x", !0),
            value: On(m.value ?? "0x", !0),
            from: m.from ?? u.address
          }, E = is({
            calls: [b],
            chainId: c,
            from: b.from
        ...
        case "wallet_sendCalls": {
            ...
            params: [
              {
                ...
                chainId: m,
                from: u.address,
                capabilities: "capabilities" in d.params[0] ? d.params[0].capabilities : {}
              }
            ]
          };
          s && (b = lt(b, {
          ...
          let E = await l(b);
          const v = await ((y = a.sign) == null ? void 0 : y.call(a, {
            // Hash returned from wallet_prepareCalls is double hex encoded
            hash: Ur(E.signatureRequest.hash)
          }));
          let P;
          if (!v)
...
async function ss({ address: e, client: t, publicKey: n, factory: r, factoryData: a }) {
  if (!await Aa(t, {
    address: e
  }) && r && a) {
    const o = Ca({
    ...
    const [u] = o.args;
    return u.findIndex((c) => c.toLowerCase() === Sa(n).toLowerCase());
  }
  const s = await mn(t, {
    address: e,
    abi: he,
...
async function gl() {
  var n;
  const e = ((n = x.config.get().metadata) == null ? void 0 : n.appName) ?? "App", t = yr();
  return new Promise((r) => {
    ur({ dialogContext: "sub_account_add_owner" }), t.presentItem({
      title: `Re-authorize ${e}`,
      message: `${e} has lost access to your account. Please sign at the next step to re-authorize ${e}`,
      onClose: () => {
        Ka({ dialogContext: "sub_account_add_owner" }), r("cancel");
      },
      actionItems: [
        {
          text: "Continue",
...
async function bl({ ownerAccount: e, globalAccountRequest: t, chainId: n }) {
  var d, y;
  ...
  me(i, k.provider.unauthorized("no global account")), me((y = r.chain) == null ? void 0 : y.id, k.provider.unauthorized("no chain id")), me(a == null ? void 0 : a.address, k.provider.unauthorized("no sub account"));
  const s = [];
  if (e.type === "local" && e.address && s.push({
    ...
    const [m, b] = Ta([{ type: "bytes32" }, { type: "bytes32" }], e.publicKey);
    s.push({
      to: a.address,
      data: Te({
        abi: he,
  ...
  const c = await t(o), f = hi(r.chain.id);
  if (me(f, k.rpc.internal(`client not found for chainId ${r.chain.id}`)), (await _a(f, {
    id: c
  })).status !== "success")
...
async function os({ request: e, globalAccountAddress: t, subAccountAddress: n, client: r, globalAccountRequest: a, chainId: i, prependCalls: s }) {
  var d;
  let o;
  if (e.method === "wallet_sendCalls" && ol(e.params))
    o = e.params[0];
  else if (e.method === "eth_sendTransaction" && cl(e.params))
    o = is({
      calls: [e.params[0]],
      chainId: i,
      from: e.params[0].from
    }).params[0];
  else
  ...
  const u = Te({
    ...
    args: [
      o.calls.map((y) => ({
        target: y.to,
        value: ct(y.value ?? "0x0"),
        data: y.data ?? "0x"
      }))
    ]
  }), c = [
    ...s ?? [],
    { data: u, to: n, value: "0x0" }
  ], f = lt({
    method: "wallet_sendCalls",
    params: [
      {
  ...
  let p = l.id;
  return (d = l.capabilities) != null && d.spendPermissions && sr.set(l.capabilities.spendPermissions.permissions), e.method === "eth_sendTransaction" ? as({
    client: r,
    id: p
  }) : l;
}
async function wl({ globalAccountAddress: e, subAccountAddress: t, client: n, request: r, globalAccountRequest: a }) {
  var o;
  const i = (o = n.chain) == null ? void 0 : o.id;
  me(i, k.rpc.internal("invalid chainId"));
  try {
    await sl();
  } catch {
...
class vl {
  constructor(t) {
    ...
    F(this, "chain");
    var a;
    this.communicator = t.communicator, this.callback = t.callback, this.keyManager = new tl();
    const { account: n, chains: r } = x.getState();
    this.accounts = n.accounts ?? [], this.chain = n.chain ?? {
      id: ((a = t.metadata.appChainIds) == null ? void 0 : a[0]) ?? 1
    }, r && ra(r);
  }
  get isConnected() {
  ...
  async handshake(t) {
    var r, a;
    const n = xe.get(t);
    Ac({ method: t.method, correlationId: n });
    try {
      ...
      }, n), s = await this.communicator.postRequestAndWaitForResponse(i);
      if ("failure" in s.content)
        throw s.content.failure;
      const o = await wi("public", s.sender);
      await this.keyManager.setPeerPublicKey(o);
      const u = await this.decryptResponseMessage(s);
      this.handleResponse(t, u), Oc({ method: t.method, correlationId: n });
    } catch (i) {
      throw Pc({
        method: t.method,
        correlationId: n,
  ...
  async request(t) {
    const n = xe.get(t);
    Ic({ method: t.method, correlationId: n });
    try {
      const r = await this._request(t);
      return Tc({ method: t.method, correlationId: n }), r;
    } catch (r) {
      throw Cc({
        method: t.method,
        correlationId: n,
  ...
  async _request(t) {
    ...
    if (this.accounts.length === 0)
      switch (t.method) {
        case "wallet_switchEthereumChain": {
          ka(t.params), this.chain.id = Number(t.params[0].chainId);
          return;
        }
        case "wallet_connect": {
          await ((r = (n = this.communicator).waitForPopupLoaded) == null ? void 0 : r.call(n)), await tr();
          const c = x.subAccountsConfig.get(), f = lt(t, (c == null ? void 0 : c.capabilities) ?? {});
    ...
    if (this.shouldRequestUseSubAccountSigner(t)) {
      const c = xe.get(t);
      _c({ method: t.method, correlationId: c });
      try {
        const f = await this.sendRequestToSubAccountSigner(t);
        return Bc({ method: t.method, correlationId: c }), f;
      } catch (f) {
        throw Rc({
          method: t.method,
          correlationId: c,
    ...
    switch (t.method) {
      ...
      case "eth_accounts": {
        const c = x.subAccounts.get(), f = x.subAccountsConfig.get();
        return c != null && c.address && (this.accounts = (f == null ? void 0 : f.defaultAccount) === "sub" ? St(this.accounts, c.address) : At(this.accounts, c.address)), (a = this.callback) == null || a.call(this, "connect", { chainId: M(this.chain.id) }), this.accounts;
      }
      case "eth_coinbase":
      ...
      case "wallet_connect": {
        ...
        const c = x.subAccountsConfig.get(), f = lt(t, (c == null ? void 0 : c.capabilities) ?? {}), l = await this.sendRequestToPopup(f);
        return (o = this.callback) == null || o.call(this, "connect", { chainId: M(this.chain.id) }), l;
      }
      case "wallet_getSubAccounts": {
        ...
        const f = await it(t, this.chain.rpcUrl);
        if (Ae(f.subAccounts, "subAccounts"), f.subAccounts.length > 0) {
          wt(f.subAccounts[0]);
          const l = f.subAccounts[0];
          x.subAccounts.set({
            address: l.address,
            factory: l.factory,
            factoryData: l.factoryData
          });
        }
        return f;
      }
      ...
      case "coinbase_fetchPermissions": {
        al(t);
        const c = il(t), f = await it(c, hn), l = mt((u = c.params) == null ? void 0 : u[0].chainId);
        return x.spendPermissions.set(f.permissions.map((p) => ({
          ...p,
          chainId: l
        }))), f;
      }
      case "coinbase_fetchPermission": {
        const f = await it(t, hn);
        return f.permission && f.permission.chainId && x.spendPermissions.set([f.permission]), f;
      }
      default:
        if (!this.chain.rpcUrl)
          throw k.rpc.internal("No RPC URL set for chain");
        return it(t, this.chain.rpcUrl);
    }
  }
  async sendRequestToPopup(t) {
    var a, i;
    await ((i = (a = this.communicator).waitForPopupLoaded) == null ? void 0 : i.call(a));
    const n = await this.sendEncryptedRequest(t), r = await this.decryptResponseMessage(n);
  ...
  async handleResponse(t, n) {
    ...
    switch (t.method) {
      ...
      case "wallet_connect": {
        const c = r.value, f = c.accounts.map((b) => b.address);
        this.accounts = f, x.account.set({
          accounts: f
        });
        const l = c.accounts.at(0), p = l == null ? void 0 : l.capabilities;
        if (p != null && p.subAccounts) {
          const b = p == null ? void 0 : p.subAccounts;
          Ae(b, "subAccounts"), wt(b[0]), x.subAccounts.set({
            address: b[0].address,
            factory: b[0].factory,
            factoryData: b[0].factoryData
          });
        }
        const d = x.subAccounts.get(), y = x.subAccountsConfig.get();
        d != null && d.address && (this.accounts = (y == null ? void 0 : y.defaultAccount) === "sub" ? St(this.accounts, d.address) : At(this.accounts, d.address));
        const m = (s = (i = c == null ? void 0 : c.accounts) == null ? void 0 : i[0].capabilities) == null ? void 0 : s.spendPermissions;
        m && "permissions" in m && x.spendPermissions.set(m == null ? void 0 : m.permissions), (o = this.callback) == null || o.call(this, "accountsChanged", this.accounts);
        break;
      }
      case "wallet_addSubAccount": {
        wt(r.value);
        const c = r.value;
        x.subAccounts.set(c);
        const f = x.subAccountsConfig.get();
        this.accounts = (f == null ? void 0 : f.defaultAccount) === "sub" ? St(this.accounts, c.address) : At(this.accounts, c.address), (u = this.callback) == null || u.call(this, "accountsChanged", this.accounts);
        break;
      }
    }
    return r.value;
  ...
  async cleanup() {
    ...
    await this.keyManager.clear(), x.account.clear(), x.subAccounts.clear(), x.spendPermissions.clear(), x.chains.clear(), this.accounts = [], this.chain = {
      id: ((n = t == null ? void 0 : t.appChainIds) == null ? void 0 : n[0]) ?? 1
    };
  }
  /**
  ...
  async handleGetCapabilitiesRequest(t) {
    ...
    if (!this.accounts.some((o) => Ls(o, n)))
    ...
    if (!r || r.length === 0)
      return a;
    const i = new Set(r.map((o) => mt(o)));
    return Object.fromEntries(Object.entries(a).filter(([o]) => {
      try {
        const u = mt(o);
        return i.has(u);
      } catch {
  ...
  async sendEncryptedRequest(t) {
    ...
    }, n), a = xe.get(t), i = await this.createRequestMessage({ encrypted: r }, a);
    return this.communicator.postRequestAndWaitForResponse(i);
  }
  async createRequestMessage(t, n) {
    const r = await bi("public", await this.keyManager.getOwnPublicKey());
    return {
      id: crypto.randomUUID(),
      correlationId: n,
      sender: r,
  ...
  async decryptResponseMessage(t) {
    ...
    const a = await ku(n.encrypted, r), i = (o = a.data) == null ? void 0 : o.chains;
    if (i) {
      const f = (u = a.data) == null ? void 0 : u.nativeCurrencies, l = Object.entries(i).map(([p, d]) => {
        const y = f == null ? void 0 : f[Number(p)];
        return {
          id: Number(p),
          rpcUrl: d,
          ...y ? { nativeCurrency: y } : {}
      ...
      x.chains.set(l), this.updateChain(this.chain.id, l), ra(l);
    }
    const s = (c = a.data) == null ? void 0 : c.capabilities;
    return s && x.account.set({
      capabilities: s
    }), a;
  }
  updateChain(t, n) {
    var s;
    const r = x.getState(), a = n ?? r.chains, i = a == null ? void 0 : a.find((o) => o.id === t);
    return i ? (i !== this.chain && (this.chain = i, x.account.set({
      chain: i
    }), (s = this.callback) == null || s.call(this, "chainChanged", ii(i.id))), !0) : !1;
  }
  async addSubAccount(t) {
    var s, o, u;
    const r = x.getState().subAccount, a = x.subAccountsConfig.get();
    if (r != null && r.address)
      return this.accounts = (a == null ? void 0 : a.defaultAccount) === "sub" ? St(this.accounts, r.address) : At(this.accounts, r.address), (s = this.callback) == null || s.call(this, "accountsChanged", this.accounts), r;
    if (await ((u = (o = this.communicator).waitForPopupLoaded) == null ? void 0 : u.call(o)), Array.isArray(t.params) && t.params.length > 0 && t.params[0].account && t.params[0].account.type === "create") {
      let c;
      if (t.params[0].account.keys && t.params[0].account.keys.length > 0)
        c = t.params[0].account.keys;
      else {
        const f = x.subAccountsConfig.get() ?? {}, { account: l } = f.toOwnerAccount ? await f.toOwnerAccount() : await er();
        if (!l)
  ...
  shouldRequestUseSubAccountSigner(t) {
    const n = Ea(t), r = x.subAccounts.get();
  ...
  async sendRequestToSubAccountSigner(t) {
    ...
    me(n == null ? void 0 : n.address, k.provider.unauthorized("no active sub account when sending request to sub account signer"));
    const i = r != null && r.toOwnerAccount ? await r.toOwnerAccount() : await er();
    me(i == null ? void 0 : i.account, k.provider.unauthorized("no active sub account owner when sending request to sub account signer")), Ea(t) === void 0 && (t = nl(t, n.address));
    const o = this.accounts.find((v) => v.toLowerCase() !== n.address.toLowerCase());
    me(o, k.provider.unauthorized("no global account found when sending request to sub account signer"));
    const u = dl({
      attribution: (m = a.preference) == null ? void 0 : m.attribution,
      dappOrigin: window.location.origin
    }), c = t.method === "wallet_sendCalls" && ((E = (b = t.params) == null ? void 0 : b[0]) == null ? void 0 : E.chainId), f = c ? mt(c) : this.chain.id, l = hi(f);
    if (me(l, k.rpc.internal(`client not found for chainId ${f} when sending request to sub account signer`)), ["eth_sendTransaction", "wallet_sendCalls"].includes(t.method)) {
      const v = x.subAccountsConfig.get();
      if ((v == null ? void 0 : v.funding) === "spend-permissions" && sr.get().length === 0)
        return await os({
          request: t,
    ...
    if (d === -1) {
      const v = xe.get(t);
      Uc({ method: t.method, correlationId: v });
      try {
        d = await bl({
          ownerAccount: i.account,
          globalAccountRequest: this.sendRequestToPopup.bind(this),
          chainId: f
        }), Nc({ method: t.method, correlationId: v });
      } catch (P) {
        return jc({
          method: t.method,
          correlationId: v,
    ...
    try {
      ...
      const P = x.subAccountsConfig.get();
      if ((P == null ? void 0 : P.funding) === "manual")
        throw v;
      let N;
      if (Ga(v))
        N = JSON.parse(v.details);
      else if (Mr(v))
        N = v;
      else
        throw v;
      if (!(Mr(N) && N.data) || !N.data)
        throw v;
      const ee = xe.get(t);
      Dc({ method: t.method, correlationId: ee });
      try {
        const ae = await wl({
          errorData: N.data,
          globalAccountAddress: o,
        ...
        return Mc({ method: t.method, correlationId: ee }), ae;
      } catch (ae) {
        throw console.error(ae), Lc({
          method: t.method,
          correlationId: ee,
          errorMessage: Ke(ae)
        }), v;
...
class xl extends pc {
  constructor({ metadata: n, preference: { walletUrl: r, ...a } }) {
    ...
    F(this, "communicator");
    F(this, "signer");
    F(this, "isBaseAccount", !0);
    this.communicator = new uc({
      url: r,
      metadata: n,
      preference: a
    }), this.signer = new vl({
  ...
  async request(n) {
    ...
    xe.set(n, r), mc({ method: n.method, correlationId: r });
    try {
  ...
  async _request(n) {
    var r;
    try {
      if (Su(n), !this.signer.isConnected)
        switch (n.method) {
          case "eth_requestAccounts": {
            await this.signer.handshake({ method: "handshake" }), await tr(), await this.signer.request({
              method: "wallet_connect",
              params: [
                {
                  version: "1",
                  capabilities: {
                    ...((r = x.subAccountsConfig.get()) == null ? void 0 : r.capabilities) ?? {}
                  }
                }
              ]
            });
      ...
      const { code: i } = a;
      return i === X.provider.unauthorized && await this.disconnect(), Promise.reject(dc(a));
    }
  }
  async disconnect() {
    await this.signer.cleanup(), xe.clear(), this.emit("disconnect", k.provider.disconnected("User initiated disconnection"));
  }
}
const El = "isCoinbaseBrowser";
function kl() {
  var t;
  const e = ((t = window.top) == null ? void 0 : t.ethereum) ?? window.ethereum;
  return e != null && e[El] ? e : null;
}
function Tl(e) {
  var a, i, s, o, u;
  const t = {
  ...
  (a = e.subAccounts) != null && a.toOwnerAccount && Lr(e.subAccounts.toOwnerAccount), x.subAccountsConfig.set({
  ...
  }), x.config.set(t), x.persist.rehydrate(), Io(), To(t.preference), t.preference.telemetry !== !1 && bo();
  let n = null;
  const r = {
    getProvider: () => (n || (n = kl() ?? new xl(t)), n),
    subAccount: {
      async create(c) {
        var f;
        return await ((f = r.getProvider()) == null ? void 0 : f.request({
      ...
      async get() {
        ...
        if (c != null && c.address)
          return c;
        const l = (d = (await ((p = r.getProvider()) == null ? void 0 : p.request({
          method: "wallet_connect",
          params: [
            {
              version: "1",
        ...
        }))).accounts[0].capabilities) == null ? void 0 : d.subAccounts;
      ...
      addOwner: async ({ address: c, publicKey: f, chainId: l }) => {
        ...
        const y = [];
        if (f) {
          const [E, v] = Ta([{ type: "bytes32" }, { type: "bytes32" }], f);
          y.push({
            to: p.address,
            data: Te({
              abi: he,
        ...
        return c && y.push({
          ...
          value: qe(0)
        }), await ((b = r.getProvider()) == null ? void 0 : b.request({
          method: "wallet_sendCalls",
          params: [
            {
              calls: y,
              chainId: qe(l),
              from: (m = d.accounts) == null ? void 0 : m[0],
              version: "1"
            }
          ]
        }));
...
export {
  et as VERSION,
  Tl as createBaseAccountSDK,
  er as getCryptoKeyAccount
};
