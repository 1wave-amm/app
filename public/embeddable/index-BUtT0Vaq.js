import { t as N, u as V, i as b, r as $, c as S, x as m, v as q, y as B, d as W, e as Y } from "./core-De0D7Wpr.js";
const w = {
...
class ct extends at {
  ...
  update(t, i) {
    ...
    for (let s = 0; s < i.length && !(s > this._$Cwt); s++) {
      ...
      s < a && l === r[s] || (this._$Cwt = D, a = 0, Promise.resolve(l).then(async (d) => {
...
const U = {
  add: async () => (await import("./add-D9SBRUny.js")).addSvg,
  allWallets: async () => (await import("./all-wallets-O06Z6GKK.js")).allWalletsSvg,
  arrowBottomCircle: async () => (await import("./arrow-bottom-circle-BAz2PtFv.js")).arrowBottomCircleSvg,
  appStore: async () => (await import("./app-store-B5StmFdV.js")).appStoreSvg,
  apple: async () => (await import("./apple-Buox5yH0.js")).appleSvg,
  arrowBottom: async () => (await import("./arrow-bottom-DyfTBJm8.js")).arrowBottomSvg,
  arrowLeft: async () => (await import("./arrow-left-DR-gp6LN.js")).arrowLeftSvg,
  arrowRight: async () => (await import("./arrow-right-CGcSlskl.js")).arrowRightSvg,
  arrowTop: async () => (await import("./arrow-top-C9xR76m-.js")).arrowTopSvg,
  bank: async () => (await import("./bank-ZDMQZRJx.js")).bankSvg,
  browser: async () => (await import("./browser-BMe0ktvY.js")).browserSvg,
  card: async () => (await import("./card-0_ew_W01.js")).cardSvg,
  checkmark: async () => (await import("./checkmark-BpOd6wWR.js")).checkmarkSvg,
  checkmarkBold: async () => (await import("./checkmark-bold-BD4nD3iD.js")).checkmarkBoldSvg,
  chevronBottom: async () => (await import("./chevron-bottom-eJ0KezmR.js")).chevronBottomSvg,
  chevronLeft: async () => (await import("./chevron-left-FO_JEQ2b.js")).chevronLeftSvg,
  chevronRight: async () => (await import("./chevron-right-B_ug7OU5.js")).chevronRightSvg,
  chevronTop: async () => (await import("./chevron-top-DmCtR8_2.js")).chevronTopSvg,
  chromeStore: async () => (await import("./chrome-store-j6TvcbqE.js")).chromeStoreSvg,
  clock: async () => (await import("./clock-Db8KUj9F.js")).clockSvg,
  close: async () => (await import("./close-CRroPuvh.js")).closeSvg,
  compass: async () => (await import("./compass-DuCjJl9C.js")).compassSvg,
  coinPlaceholder: async () => (await import("./coinPlaceholder-DDMeuAO4.js")).coinPlaceholderSvg,
  copy: async () => (await import("./copy-BxIOnS8a.js")).copySvg,
  cursor: async () => (await import("./cursor-hYuusK5W.js")).cursorSvg,
  cursorTransparent: async () => (await import("./cursor-transparent-DCIr0OmW.js")).cursorTransparentSvg,
  desktop: async () => (await import("./desktop-CJDcRiq0.js")).desktopSvg,
  disconnect: async () => (await import("./disconnect-CPpW9n45.js")).disconnectSvg,
  discord: async () => (await import("./discord-C_8s96WW.js")).discordSvg,
  etherscan: async () => (await import("./etherscan-CLf6qDGD.js")).etherscanSvg,
  extension: async () => (await import("./extension-C1gPHYgZ.js")).extensionSvg,
  externalLink: async () => (await import("./external-link-CQ_D4Lhx.js")).externalLinkSvg,
  facebook: async () => (await import("./facebook-DB-BFubO.js")).facebookSvg,
  farcaster: async () => (await import("./farcaster-CbiIseNx.js")).farcasterSvg,
  filters: async () => (await import("./filters-BS4nKlKP.js")).filtersSvg,
  github: async () => (await import("./github-B02feA_S.js")).githubSvg,
  google: async () => (await import("./google-ZrFLq-x8.js")).googleSvg,
  helpCircle: async () => (await import("./help-circle-BslxuzxR.js")).helpCircleSvg,
  image: async () => (await import("./image-kbLLeFtl.js")).imageSvg,
  id: async () => (await import("./id-Df1L5uQf.js")).idSvg,
  infoCircle: async () => (await import("./info-circle-D4c-gxma.js")).infoCircleSvg,
  lightbulb: async () => (await import("./lightbulb-DSatOBjv.js")).lightbulbSvg,
  mail: async () => (await import("./mail-Bb4hYU44.js")).mailSvg,
  mobile: async () => (await import("./mobile-CXRY92qr.js")).mobileSvg,
  more: async () => (await import("./more-DB9qDZGF.js")).moreSvg,
  networkPlaceholder: async () => (await import("./network-placeholder-BWIbKcjq.js")).networkPlaceholderSvg,
  nftPlaceholder: async () => (await import("./nftPlaceholder-3-O4yDk8.js")).nftPlaceholderSvg,
  off: async () => (await import("./off-Dk40iFvu.js")).offSvg,
  playStore: async () => (await import("./play-store-tiZ0gzcA.js")).playStoreSvg,
  plus: async () => (await import("./plus-6s6x0g2Q.js")).plusSvg,
  qrCode: async () => (await import("./qr-code-IS3GgPho.js")).qrCodeIcon,
  recycleHorizontal: async () => (await import("./recycle-horizontal-BoPyLvR1.js")).recycleHorizontalSvg,
  refresh: async () => (await import("./refresh-BQXHx4id.js")).refreshSvg,
  search: async () => (await import("./search-Bv3TTBrj.js")).searchSvg,
  send: async () => (await import("./send-DRbnEocT.js")).sendSvg,
  swapHorizontal: async () => (await import("./swapHorizontal-CDtR9_8D.js")).swapHorizontalSvg,
  swapHorizontalMedium: async () => (await import("./swapHorizontalMedium-Cd8f1gHv.js")).swapHorizontalMediumSvg,
  swapHorizontalBold: async () => (await import("./swapHorizontalBold-DctVKmls.js")).swapHorizontalBoldSvg,
  swapHorizontalRoundedBold: async () => (await import("./swapHorizontalRoundedBold-Cu9W77kg.js")).swapHorizontalRoundedBoldSvg,
  swapVertical: async () => (await import("./swapVertical-kAA6KKc_.js")).swapVerticalSvg,
  telegram: async () => (await import("./telegram-Fr2639R4.js")).telegramSvg,
  threeDots: async () => (await import("./three-dots-BHNfFeJa.js")).threeDotsSvg,
  twitch: async () => (await import("./twitch-WdlyhLJi.js")).twitchSvg,
  twitter: async () => (await import("./x-CZfcLRMq.js")).xSvg,
  twitterIcon: async () => (await import("./twitterIcon-BeMUx4O2.js")).twitterIconSvg,
  verify: async () => (await import("./verify-CmeuogSS.js")).verifySvg,
  verifyFilled: async () => (await import("./verify-filled-C3mWi8e0.js")).verifyFilledSvg,
  wallet: async () => (await import("./wallet-BDCL9Cr5.js")).walletSvg,
  walletConnect: async () => (await import("./walletconnect-CBHTBXa9.js")).walletConnectSvg,
  walletConnectLightBrown: async () => (await import("./walletconnect-CBHTBXa9.js")).walletConnectLightBrownSvg,
  walletConnectBrown: async () => (await import("./walletconnect-CBHTBXa9.js")).walletConnectBrownSvg,
  walletPlaceholder: async () => (await import("./wallet-placeholder-biIdbPTg.js")).walletPlaceholderSvg,
  warningCircle: async () => (await import("./warning-circle-lxMEnCmd.js")).warningCircleSvg,
  x: async () => (await import("./x-CZfcLRMq.js")).xSvg,
  info: async () => (await import("./info-D6PE0LW7.js")).infoSvg,
  exclamationTriangle: async () => (await import("./exclamation-triangle-BWg8KAiV.js")).exclamationTriangleSvg,
  reown: async () => (await import("./reown-logo-qe4ld9lU.js")).reownSvg
};
async function pt(e) {
  if (O.has(e))
    return O.get(e);
